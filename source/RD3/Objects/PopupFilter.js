...
PopupFilter.prototype.RealizeComboFilter = function()
{
  ...
  commonControlsArea.className = "filter-common-controls filter-card";
  //
  if (this.ParentField.HasValueSource || (this.ParentField.ValueList && !this.ParentField.LKE) || (this.ParentField.PValues.length >= 1 && this.ParentField.PValues[this.ParentField.ParentPanel.ActualPosition] && this.ParentField.PValues[this.ParentField.ParentPanel.ActualPosition].ValueList))
  {
    var selAllRow = document.createElement("DIV");
    selAllRow.className = "filter-row-filter check-line";
    var selAllImg = document.createElement("IMG");
