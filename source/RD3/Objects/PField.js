...
PField.prototype.IsVisible = function(flIgnoreGroup)
{
  ...
  if (vis && this.ParentPanel.PanelMode == RD3_Glb.PANEL_LIST && this.InList && this.ListList && this.HiddenInList() && this.ParentPanel.HasListVisibilityControl)
    vis = false;
  //
  return vis;
}
...
PField.prototype.OnHTML5Upload = function(ev, idUploader, dropFiles)
{
  ...
  if (window.RD4_Enabled)
  {
    ...
    var file = dropFiles ? dropFiles[0] : objUploader.files[0];
    ...
    reader.onload = (
      function(fld, name, type)
      {
        return (function(e)
        {
          ...
          var ev = new IDEvent((fld.MultiUpload ? "IWFiles" : "IWUpload"), "", null, RD3_Glb.EVENT_ACTIVE, "", fld.Identifier, name, type, e.target.result);
        });
