...
{ 
  ...
  var delta = window.event && !RD3_Glb.IsFirefox() ? eve.wheelDelta : (eve.detail!=0 ? -eve.detail*40 : eve.wheelDelta);
  //
...
IDPanel.prototype.ListVisibilityCtrlToggleClicked = function (ev, fld) 
{
  ...
  if (fld && !RD3_Glb.IsMobile() && (this.UseListQBE == RD3_Glb.PAN_QBEHEADER) && this.CanSearch && (fld.QBEEnabled && (fld.IdxPanel <= 0 || (fld.IdxPanel > 0 && (fld.AutoLookup || fld.LKE)))) && (fld.DataType != 10)) {
