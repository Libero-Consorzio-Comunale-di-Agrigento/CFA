// **********************************************
// Estrazione Dati Certificato Consuntivo
// Project : Cfa
// **********************************************
...
public final class EstrazioneDatiCertificatoConsuntivo extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_PARAM72 = 0;
  ...
  {
    Init_TBL_PARAM92(IMDB);
    //
    //
    Init_PQRY_PARAM72(IMDB);
    Init_PQRY_PARAM72_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAM92(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef3.TBL_PARAM92, 1);
    IMDB.set_TblCode(IMDBDef3.TBL_PARAM92, "TBL_PARAM92");
    IMDB.set_FldCode(IMDBDef3.TBL_PARAM92,IMDBDef3.FLD_PARAM92_ROWNAMEES, "ROWNAMEES");
    IMDB.SetFldParams(IMDBDef3.TBL_PARAM92,IMDBDef3.FLD_PARAM92_ROWNAMEES,5,1,0);
    IMDB.TblAddNew(IMDBDef3.TBL_PARAM92, 0);
  }

  private static void Init_PQRY_PARAM72(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef12.PQRY_PARAM72, 1);
    IMDB.set_TblCode(IMDBDef12.PQRY_PARAM72, "PQRY_PARAM72");
    IMDB.set_FldCode(IMDBDef12.PQRY_PARAM72,IMDBDef12.PQSL_PARAM72_ROWNAMEES, "ROWNAMEES");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARAM72,IMDBDef12.PQSL_PARAM72_ROWNAMEES,5,1,0);
    IMDB.TblAddNew(IMDBDef12.PQRY_PARAM72, 0);
  }

  private static void Init_PQRY_PARAM72_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef12.PQRY_PARAM72_RS, 1);
    IMDB.set_TblCode(IMDBDef12.PQRY_PARAM72_RS, "PQRY_PARAM72_RS");
    IMDB.set_FldCode(IMDBDef12.PQRY_PARAM72_RS,IMDBDef12.PQSL_PARAM72_ROWNAMEES, "ROWNAMEES");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARAM72_RS,IMDBDef12.PQSL_PARAM72_ROWNAMEES,5,1,0);
  }
  ...
  // **********************************************
  public EstrazioneDatiCertificatoConsuntivo(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public EstrazioneDatiCertificatoConsuntivo()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_ESTDATCERCON;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "1E32121E-E298-495C-ABBD-BE4E468CC913";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 212;
    DesignHeight = 154;
    set_Caption(new IDVariant("Estrazione Dati Certificato Consuntivo"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 212-MyGlb.PAN_OFFS_X, 128-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "4F934BE4-9E8A-48CD-9AAA-3E4318E4F86F");
    PAN_PARAM.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 64, 176, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef3.TBL_PARAM92, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        ESTDATCERCON_PARAM72();
      }
  ...
  {
    return (obj instanceof EstrazioneDatiCertificatoConsuntivo);
  }
  ...
  {
    return (FullName ? EstrazioneDatiCertificatoConsuntivo.class.getName() : (Glb.ClassWithPackage(EstrazioneDatiCertificatoConsuntivo.class) ? EstrazioneDatiCertificatoConsuntivo.class.getName().substring(EstrazioneDatiCertificatoConsuntivo.class.getPackage().getName().length() + 1) : EstrazioneDatiCertificatoConsuntivo.class.getName()));
  }
  ...
  public int Elabora ()
  {
    ...
    {
      TransCount = 0;
      v_FASE = (new IDVariant("CERT_CON", IDVariant.STRING));
      ...
      MainFrm.Cf4armDBObject.GENERACERTCONS(MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef12.PQRY_PARAM72, IMDBDef12.PQSL_PARAM72_ROWNAMEES, 0));
      ...
      // 
      {
        ...
        // 
        {
          ...
          MainFrm.VBFile.OpenForOutput(IDL.Add(IDL.Add((new IDVariant(MainFrm.RealPath)), (new IDVariant("/"))), ((IMDB.Value(IMDBDef12.PQRY_PARAM72, IMDBDef12.PQSL_PARAM72_ROWNAMEES, 0).equals((new IDVariant("E"))))?v_OUTFILE:v_OUTFILE1)), v_FD, false); 
          ...
          if (IMDB.Value(IMDBDef12.PQRY_PARAM72, IMDBDef12.PQSL_PARAM72_ROWNAMEES, 0).equals((new IDVariant("E")), true))
          {
    ...
    {
      MainFrm.ErrObj.ProcError ("EstrazioneDatiCertificatoConsuntivo", "Elabora", _e);
      return -1;
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      TransCount = 0;
      v_CAPTION = (new IDVariant("Estrazione Dati Certificato Consuntivo", IDVariant.STRING));
      ...
      IMDB.set_Value(IMDBDef3.TBL_PARAM92, IMDBDef3.FLD_PARAM92_ROWNAMEES, 0, (new IDVariant("E")));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("EstrazioneDatiCertificatoConsuntivo", "LoadEvent", _e);
    }
  }
  ...
  // **********************************************************************
  private void ESTDATCERCON_PARAM72() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef12.PQRY_PARAM72_RS);
    IMDB.TblMoveFirst(IMDBDef3.TBL_PARAM92, 0);
    Loop1: while (!IMDB.Eof(IMDBDef3.TBL_PARAM92, 0))
    {
      IMDB.TblAddNew(IMDBDef12.PQRY_PARAM72_RS, 0);
      IMDB.TblLinkRow(IMDBDef12.PQRY_PARAM72_RS, 0, IMDBDef3.TBL_PARAM92, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARAM72_RS, 0, 0, IMDBDef3.TBL_PARAM92, IMDBDef3.FLD_PARAM92_ROWNAMEES, 0);
      IMDB.TblMoveNext(IMDBDef3.TBL_PARAM92, 0);
      if (IMDB.Eof(IMDBDef3.TBL_PARAM92, 0))
      {
        IMDB.TblMoveFirst(IMDBDef3.TBL_PARAM92, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef12.PQRY_PARAM72_RS, 0);
  }
  ...
  private void PAN_PARAM_Init()
  {
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_GROUP, GRP_PARAM_PARTE, "5CEDFA25-48D5-4BA4-9DF5-AC556E57A367");
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_GROUP, GRP_PARAM_PARTE, MyGlb.PANEL_FORM, 20, 10, 156, 38, 0, 0);
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_PARTE, "CF7BF662-58CB-4F40-89D2-5BC4F35B123B");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_ELABORA, "6EAAA4BF-6D81-4CA1-93E4-AC4B957FBE74");
  ...
  private void PAN_PARAM_InitFields()
  {
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_PARTE, MyGlb.PANEL_FORM, 24, 24, 148, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_PARTE, PPQRY_PARAM72, "A.ROWNAMEES", "ROWNAMEES", 5, 1, 0, -13997);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_ELABORA, MyGlb.PANEL_FORM, 96, 68, 80, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  private void PAN_PARAM_InitQueries()
  {
    ...
    PAN_PARAM.SetIMDB(IMDB, "PQRY_PARAM72", true);
    PAN_PARAM.set_SetString(MyGlb.MASTER_ROWNAME, "Row Name");
    PAN_PARAM.SetQueryIMDB(PPQRY_PARAM72, IMDBDef12.PQRY_PARAM72_RS, IMDBDef3.TBL_PARAM92);
    JustLoaded = true;
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_PARTE, IMDBDef3.FLD_PARAM92_ROWNAMEES);
    PAN_PARAM.SetMasterTable(0, "PARAM92");
    //
