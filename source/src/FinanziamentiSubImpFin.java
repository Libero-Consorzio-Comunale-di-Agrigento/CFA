...
public final class FinanziamentiSubImpFin extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_SUBIMPFIN3 = 0;
  ...
  {
    Init_TBL_PARAMETRI314(IMDB);
    //
    //
    Init_PQRY_SUBIMPFIN3(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI314(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI314, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI314, "TBL_PARAMETRI314");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI314,IMDBDef1.FLD_PARAMETRI314_PARANNSUBIMP, "PARANNSUBIMP");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI314,IMDBDef1.FLD_PARAMETRI314_PARANNSUBIMP,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI314,IMDBDef1.FLD_PARAMETRI314_PARNUMSUBIMP, "PARNUMSUBIMP");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI314,IMDBDef1.FLD_PARAMETRI314_PARNUMSUBIMP,1,5,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI314, 0);
  }

  private static void Init_PQRY_SUBIMPFIN3(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_SUBIMPFIN3, 2);
    IMDB.set_TblCode(IMDBDef7.PQRY_SUBIMPFIN3, "PQRY_SUBIMPFIN3");
    IMDB.set_FldCode(IMDBDef7.PQRY_SUBIMPFIN3,IMDBDef7.PQSL_SUBIMPFIN3_FINANZIAMENTO, "FINANZIAMENTO");
    IMDB.SetFldParams(IMDBDef7.PQRY_SUBIMPFIN3,IMDBDef7.PQSL_SUBIMPFIN3_FINANZIAMENTO,1,5,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_SUBIMPFIN3,IMDBDef7.PQSL_SUBIMPFIN3_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_SUBIMPFIN3,IMDBDef7.PQSL_SUBIMPFIN3_DESCRIZIONE,5,200,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_SUBIMPFIN3, 0);
  }
  ...
  // **********************************************
  public FinanziamentiSubImpFin(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_FINSUBIMPFIN;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "50A5C63C-21FA-4110-9146-AD96700E1774";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 712;
    DesignHeight = 426;
    set_Caption(new IDVariant("Finanziamenti Sub Imp Fin"));
    //
    Frames = new AFrame[2];
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 712-MyGlb.PAN_OFFS_X, 400-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "84935EF3-D463-406C-97F2-7D5EC7C7B9DD");
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 668, 236, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  {
    return (obj instanceof FinanziamentiSubImpFin);
  }
  ...
  {
    return (FullName ? FinanziamentiSubImpFin.class.getName() : (Glb.ClassWithPackage(FinanziamentiSubImpFin.class) ? FinanziamentiSubImpFin.class.getName().substring(FinanziamentiSubImpFin.class.getPackage().getName().length() + 1) : FinanziamentiSubImpFin.class.getName()));
  }
  ...
  private void PAN_FINANZIAMENT_DynamicProperties ()
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      PAN_FINANZIAMENT.set_ToolTip(Glb.OBJ_FIELD,PFL_FINANZIAMENT_DESCRIZIONE,(new IDVariant(PAN_FINANZIAMENT.FieldText(PFL_FINANZIAMENT_DESCRIZIONE))).stringValue()); 
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("FinanziamentiSubImpFin", "FinanziamentiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("FinanziamentiSubImpFin", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_FINANZIAMENT_Init()
  {
    ...
    PAN_FINANZIAMENT.SetSize(MyGlb.OBJ_FIELD, 2);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_FINANZIAMENT, "7C0A90D1-D156-4119-874E-DD0C187F229C");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, "8A377D2A-902A-4392-90F9-013CD66053BA");
  ...
  private void PAN_FINANZIAMENT_InitFields()
  {
    ...
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_FINANZIAMENT, MyGlb.PANEL_LIST, 92);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_FINANZIAMENT, MyGlb.PANEL_FORM, 4, 52, 160, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_FINANZIAMENT, MyGlb.PANEL_FORM, 104);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_FINANZIAMENT, PPQRY_SUBIMPFIN3, "A.FINANZIAMENTO", "FINANZIAMENTO", 1, 5, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, MyGlb.PANEL_LIST, 112, 36, 556, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, MyGlb.PANEL_FORM, 4, 76, 584, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, MyGlb.PANEL_FORM, 76);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_DESCRIZIONE, PPQRY_SUBIMPFIN3, "B.DESCRIZIONE", "DESCRIZIONE", 5, 200, 0, -13997);
  }
  ...
  private void PAN_FINANZIAMENT_InitQueries()
  {
    ...
    PAN_FINANZIAMENT.SetIMDB(IMDB, "PQRY_SUBIMPFIN3", true);
    PAN_FINANZIAMENT.set_SetString(MyGlb.MASTER_ROWNAME, "SUBIMP FIN");
    SQL = new StringBuffer();
    SQL.append("select ");
    SQL.append("  A.FINANZIAMENTO as FINANZIAMENTO, ");
    SQL.append("  B.DESCRIZIONE as DESCRIZIONE ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  SUBIMP_FIN A, ");
    SQL.append("  FINANZIAMENTI B ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ANNO_SUBIMP = ~~TBL_PARAMETRI314.PARANNSUBIMP~~) ");
    SQL.append("and   (A.NUMERO_SUBIMP = ~~TBL_PARAMETRI314.PARNUMSUBIMP~~) ");
    SQL.append("and   (A.FINANZIAMENTO = B.CODICE(+)) ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_SUBIMPFIN3, 5, SQL, -1, "");
    PAN_FINANZIAMENT.SetQueryDB(PPQRY_SUBIMPFIN3, MainFrm.Cf4armDBObject.DB, 4);
