// **********************************************
// Elenco Voci Peg Con Stanziamento Effettivo
// Project : Cfa
// **********************************************
...
public final class ElencoVociPegConStanziamentoEffettivo extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_VOCIPEG_VOCECAPITART = 2;
  private static int PFL_VOCIPEG_DESCRIZIONE = 3;

  private static int PPQRY_BIL2 = 0;
  ...
  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI308(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI308, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI308, "TBL_PARAMETRI308");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI308,IMDBDef1.FLD_PARAMETRI308_PARAMESERCIZ, "PARAMESERCIZ");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI308,IMDBDef1.FLD_PARAMETRI308_PARAMESERCIZ,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI308,IMDBDef1.FLD_PARAMETRI308_PARAMES, "PARAMES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI308,IMDBDef1.FLD_PARAMETRI308_PARAMES,5,1,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI308, 0);
  }

  private static void Init_PQRY_BIL2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_BIL2, 5);
    IMDB.set_TblCode(IMDBDef7.PQRY_BIL2, "PQRY_BIL2");
    IMDB.set_FldCode(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_ESERCIZIO, "ESERCIZIO");
    IMDB.SetFldParams(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_ESERCIZIO,3,12,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_E_S, "E_S");
    IMDB.SetFldParams(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_E_S,5,1,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_CAPITOLO, "CAPITOLO");
    IMDB.SetFldParams(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_CAPITOLO,3,16,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_ARTICOLO, "ARTICOLO");
    IMDB.SetFldParams(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_ARTICOLO,1,2,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_BIL2,IMDBDef7.PQSL_BIL2_DESCRIZIONE,5,140,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_BIL2, 0);
  }
  ...
  // **********************************************
  public ElencoVociPegConStanziamentoEffettivo(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public ElencoVociPegConStanziamentoEffettivo()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_ELVOPECOSTEF;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "58B25DBD-6C0D-44B9-AD00-E15CEFD1339F";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 540;
    DesignHeight = 382;
    set_Caption(new IDVariant("Elenco Voci Peg Con Stanziamento Effettivo"));
    //
    Frames = new AFrame[2];
    ...
    PAN_VOCIPEG.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "374CB011-12CE-46B5-98E3-D2F675EE3883");
  ...
  {
    return (obj instanceof ElencoVociPegConStanziamentoEffettivo);
  }
  ...
  {
    return (FullName ? ElencoVociPegConStanziamentoEffettivo.class.getName() : (Glb.ClassWithPackage(ElencoVociPegConStanziamentoEffettivo.class) ? ElencoVociPegConStanziamentoEffettivo.class.getName().substring(ElencoVociPegConStanziamentoEffettivo.class.getPackage().getName().length() + 1) : ElencoVociPegConStanziamentoEffettivo.class.getName()));
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("ElencoVociPegConStanziamentoEffettivo", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_VOCIPEG_Init()
  {
    ...
    PAN_VOCIPEG.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIPEG_CAPITOLO, "9DBB9F65-C9C0-4B32-A40A-F62F98BC79DE");
    ...
    PAN_VOCIPEG.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIPEG_ARTICOLO, "D54A5F14-5D7B-4921-9F11-2D45E267D3DA");
    ...
    PAN_VOCIPEG.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, "CBA968A3-DAE5-4158-9264-9BD4DF01131F");
    PAN_VOCIPEG.set_Header(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, "Capitolo/Art.");
    PAN_VOCIPEG.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.VIS_LABEVISUSTYL);
    PAN_VOCIPEG.SetFlags(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_INLIST, -1);
    PAN_VOCIPEG.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIPEG_DESCRIZIONE, "E99AD150-09F4-447D-A81C-05E9378DEB65");
  ...
  private void PAN_VOCIPEG_InitFields()
  {
    ...
    StringBuffer SQL = new StringBuffer();
    PAN_VOCIPEG.SetRect(MyGlb.OBJ_FIELD, PFL_VOCIPEG_CAPITOLO, MyGlb.PANEL_LIST, 0, 36, 100, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_VOCIPEG.SetFieldPanel(PFL_VOCIPEG_CAPITOLO, PPQRY_BIL2, "A.CAPITOLO", "CAPITOLO", 3, 16, 0, -13997);
    PAN_VOCIPEG.SetRect(MyGlb.OBJ_FIELD, PFL_VOCIPEG_ARTICOLO, MyGlb.PANEL_LIST, 100, 36, 28, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_VOCIPEG.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_VOCIPEG_ARTICOLO, MyGlb.PANEL_LIST, "AR.");
    ...
    PAN_VOCIPEG.SetFieldPanel(PFL_VOCIPEG_ARTICOLO, PPQRY_BIL2, "A.ARTICOLO", "ARTICOLO", 1, 2, 0, -13997);
    PAN_VOCIPEG.SetRect(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_LIST, 0, 0, 128, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_VOCIPEG.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_LIST, 0);
    PAN_VOCIPEG.SetNumRow(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_LIST, 2);
    PAN_VOCIPEG.SetRect(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_FORM, 0, 0, 144, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_VOCIPEG.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_FORM, 0);
    PAN_VOCIPEG.SetNumRow(MyGlb.OBJ_FIELD, PFL_VOCIPEG_VOCECAPITART, MyGlb.PANEL_FORM, 2);
    PAN_VOCIPEG.SetFieldPage(PFL_VOCIPEG_VOCECAPITART, -1, -1);
    PAN_VOCIPEG.SetFieldPanel(PFL_VOCIPEG_VOCECAPITART, -1, "", "VOCECAPITART", 0, 0, 0, -13997);
    ...
    PAN_VOCIPEG.SetFieldPanel(PFL_VOCIPEG_DESCRIZIONE, PPQRY_BIL2, "B.DESCRIZIONE", "DESCRIZIONE", 5, 140, 0, -13997);
  }
  ...
  private void PAN_VOCIPEG_InitQueries()
  {
    ...
    PAN_VOCIPEG.SetIMDB(IMDB, "PQRY_BIL2", true);
    ...
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  BIL A, ");
    SQL.append("  CAP B ");
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ESERCIZIO = ~~TBL_PARAMETRI308.PARAMESERCIZ~~) ");
    SQL.append("and   (A.E_S = ~~TBL_PARAMETRI308.PARAMES~~) ");
    ...
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIPEG.SetQuery(PPQRY_BIL2, 5, SQL, -1, "");
    PAN_VOCIPEG.SetQueryDB(PPQRY_BIL2, MainFrm.Cf4armDBObject.DB, 4);
    PAN_VOCIPEG.SetMasterTable(0, "BIL");
    //
