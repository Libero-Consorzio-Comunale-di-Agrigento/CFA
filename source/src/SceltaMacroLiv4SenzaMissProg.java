// **********************************************
// Scelta Macro Liv 4 Senza Miss Prog
// Project : Cfa
// **********************************************
...
public final class SceltaMacroLiv4SenzaMissProg extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_VISTSTRURIC1 = 0;
  ...
  {
    Init_TBL_PARS94(IMDB);
    //
    //
    Init_PQRY_VISTSTRURIC1(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS94(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARS94, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARS94, "TBL_PARS94");
    IMDB.set_FldCode(IMDBDef1.TBL_PARS94,IMDBDef1.FLD_PARS94_NOMEOGGEESER, "NOMEOGGEESER");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS94,IMDBDef1.FLD_PARS94_NOMEOGGEESER,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS94,IMDBDef1.FLD_PARS94_NOMEOGGETTES, "NOMEOGGETTES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS94,IMDBDef1.FLD_PARS94_NOMEOGGETTES,5,1,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARS94, 0);
  }

  private static void Init_PQRY_VISTSTRURIC1(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef8.PQRY_VISTSTRURIC1, 2);
    IMDB.set_TblCode(IMDBDef8.PQRY_VISTSTRURIC1, "PQRY_VISTSTRURIC1");
    IMDB.set_FldCode(IMDBDef8.PQRY_VISTSTRURIC1,IMDBDef8.PQSL_VISTSTRURIC1_VISSTRRICCOD, "VISSTRRICCOD");
    IMDB.SetFldParams(IMDBDef8.PQRY_VISTSTRURIC1,IMDBDef8.PQSL_VISTSTRURIC1_VISSTRRICCOD,1,10,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_VISTSTRURIC1,IMDBDef8.PQSL_VISTSTRURIC1_VISSTRRICDES, "VISSTRRICDES");
    IMDB.SetFldParams(IMDBDef8.PQRY_VISTSTRURIC1,IMDBDef8.PQSL_VISTSTRURIC1_VISSTRRICDES,5,300,0);
    IMDB.TblAddNew(IMDBDef8.PQRY_VISTSTRURIC1, 0);
  }
  ...
  // **********************************************
  public SceltaMacroLiv4SenzaMissProg(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SceltaMacroLiv4SenzaMissProg()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCMALI4SEMIP;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "E1BCC303-DB48-4F20-A9D0-CE3EAD3A15AB";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 640;
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "596F00FC-FA40-4C00-B65E-117167B01F2A");
  ...
  {
    return (obj instanceof SceltaMacroLiv4SenzaMissProg);
  }
  ...
  {
    return (FullName ? SceltaMacroLiv4SenzaMissProg.class.getName() : (Glb.ClassWithPackage(SceltaMacroLiv4SenzaMissProg.class) ? SceltaMacroLiv4SenzaMissProg.class.getName().substring(SceltaMacroLiv4SenzaMissProg.class.getPackage().getName().length() + 1) : SceltaMacroLiv4SenzaMissProg.class.getName()));
  }
  ...
  private void PAN_VISTSTRURICL_Init()
  {
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_CODICE, "5CDB17E0-9EB8-413F-AE92-A131F1EB1AC9");
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_DESCRIZIONE, "76685D60-73DF-4525-8642-5176936BB827");
  ...
  private void PAN_VISTSTRURICL_InitFields()
  {
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_CODICE, PPQRY_VISTSTRURIC1, "A.CODICE", "VISSTRRICCOD", 1, 10, 0, -13997);
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_DESCRIZIONE, PPQRY_VISTSTRURIC1, "A.DESCRIZIONE", "VISSTRRICDES", 5, 300, 0, -13997);
  }
  ...
  private void PAN_VISTSTRURICL_InitQueries()
  {
    ...
    PAN_VISTSTRURICL.SetIMDB(IMDB, "PQRY_VISTSTRURIC1", true);
    ...
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  VISTA_STRUTTURA_RICL A ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.CODICE_TIPO_RICL = 'MACRO') ");
    SQL.append("and   (A.E_S = ~~TBL_PARS94.NOMEOGGETTES~~) ");
    SQL.append("and   (A.LIVELLO = 4) ");
    SQL.append("and   (NVL(A.ESERCIZIO_INIZIO, 0) <= ~~TBL_PARS94.NOMEOGGEESER~~) ");
    SQL.append("and   (A.ESERCIZIO_SCADENZA >= ~~TBL_PARS94.NOMEOGGEESER~~) ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC1, 5, SQL, -1, "");
    PAN_VISTSTRURICL.SetQueryDB(PPQRY_VISTSTRURIC1, MainFrm.Cf4armDBObject.DB, 4);
