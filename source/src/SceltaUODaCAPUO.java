...
public final class SceltaUODaCAPUO extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_CAPUO2 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    ...
    //
    //
    Init_PQRY_CAPUO2(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_IN19(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_IN19, 4);
    IMDB.set_TblCode(IMDBDef1.TBL_IN19, "TBL_IN19");
    IMDB.set_FldCode(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGEESER, "NOMEOGGEESER");
    IMDB.SetFldParams(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGEESER,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGETTES, "NOMEOGGETTES");
    IMDB.SetFldParams(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGETTES,5,1,0);
    IMDB.set_FldCode(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGECAPI, "NOMEOGGECAPI");
    IMDB.SetFldParams(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGECAPI,1,16,0);
    IMDB.set_FldCode(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGEARTI, "NOMEOGGEARTI");
    IMDB.SetFldParams(IMDBDef1.TBL_IN19,IMDBDef1.FLD_IN19_NOMEOGGEARTI,1,2,0);
    IMDB.TblAddNew(IMDBDef1.TBL_IN19, 0);
  }

  private static void Init_PQRY_CAPUO2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef8.PQRY_CAPUO2, 3);
    IMDB.set_TblCode(IMDBDef8.PQRY_CAPUO2, "PQRY_CAPUO2");
    IMDB.set_FldCode(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_CAPUOPROUNOR, "CAPUOPROUNOR");
    IMDB.SetFldParams(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_CAPUOPROUNOR,1,8,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_CODIUNITORGA, "CODIUNITORGA");
    IMDB.SetFldParams(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_CODIUNITORGA,5,99,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef8.PQRY_CAPUO2,IMDBDef8.PQSL_CAPUO2_DESCRIZIONE,5,99,0);
    IMDB.TblAddNew(IMDBDef8.PQRY_CAPUO2, 0);
  }
  ...
  // **********************************************
  public SceltaUODaCAPUO(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCEUODACAPUO;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "A2ADEEFD-4B4F-4C50-8359-99665F3424D3";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 660;
    ...
    PAN_SCELUNITORGA.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "CA876475-A231-4ED3-8032-CF9FE2C3CEEC");
  ...
  {
    return (obj instanceof SceltaUODaCAPUO);
  }
  ...
  {
    return (FullName ? SceltaUODaCAPUO.class.getName() : (Glb.ClassWithPackage(SceltaUODaCAPUO.class) ? SceltaUODaCAPUO.class.getName().substring(SceltaUODaCAPUO.class.getPackage().getName().length() + 1) : SceltaUODaCAPUO.class.getName()));
  }
  ...
  private void PAN_SCELUNITORGA_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaUODaCAPUO", "SceltaUnitàOrganizzativeOnDynamicProperties", _e);
    }
  }
  ...
  private void PAN_SCELUNITORGA_Init()
  {
    ...
    PAN_SCELUNITORGA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELUNITORGA_PROGUNITORGA, "4C68ACCE-A142-4A21-80C8-D2F9EEDA7157");
    ...
    PAN_SCELUNITORGA.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_SCELUNITORGA_PROGUNITORGA, MyGlb.VIS_PRIMAKEYFIEL);
    PAN_SCELUNITORGA.SetFlags(MyGlb.OBJ_FIELD, PFL_SCELUNITORGA_PROGUNITORGA, 0 | MyGlb.FLD_ISKEY, -1);
    PAN_SCELUNITORGA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELUNITORGA_CODIUNITORGA, "61C6BEB2-D5BB-429C-B8E9-5928F671FA9F");
    ...
    PAN_SCELUNITORGA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELUNITORGA_DESCRIZIONE, "D2DD97C7-3129-49C0-AB77-A90A7C2FE372");
  ...
  private void PAN_SCELUNITORGA_InitFields()
  {
    ...
    PAN_SCELUNITORGA.SetFieldPanel(PFL_SCELUNITORGA_PROGUNITORGA, PPQRY_CAPUO2, "A.PROGR_UNITA_ORGANIZZATIVA", "CAPUOPROUNOR", 1, 8, 0, -13997);
    ...
    PAN_SCELUNITORGA.SetFieldPanel(PFL_SCELUNITORGA_CODIUNITORGA, PPQRY_CAPUO2, "SO4_UTIL.UNITA_GET_CODICE_VALIDO(A.PROGR_UNITA_ORGANIZZATIVA,TRUNC( SYSDATE ))", "CODIUNITORGA", 5, 99, 0, -13997);
    ...
    PAN_SCELUNITORGA.SetFieldPanel(PFL_SCELUNITORGA_DESCRIZIONE, PPQRY_CAPUO2, "SO4_UTIL.UNITA_GET_DESCR_VALIDA(A.PROGR_UNITA_ORGANIZZATIVA,TRUNC( SYSDATE ))", "DESCRIZIONE", 5, 99, 0, -13997);
  }
  ...
  private void PAN_SCELUNITORGA_InitQueries()
  {
    ...
    PAN_SCELUNITORGA.SetIMDB(IMDB, "PQRY_CAPUO2", true);
    ...
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  CAP_UO A ");
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ESERCIZIO = ~~TBL_IN19.NOMEOGGEESER~~) ");
    SQL.append("and   (A.E_S = ~~TBL_IN19.NOMEOGGETTES~~) ");
    SQL.append("and   (A.CAPITOLO = ~~TBL_IN19.NOMEOGGECAPI~~) ");
    SQL.append("and   (A.ARTICOLO = ~~TBL_IN19.NOMEOGGEARTI~~) ");
    SQL.append("and   (A.TIPO_UNITA_ORGANIZZATIVA = 'G') ");
    SQL.append("and   (NVL(A.SCADENZA, TO_DATE('2999-12-31','YYYY-MM-DD')) >= TRUNC( SYSDATE )) ");
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by 2, 3 ");
    PAN_SCELUNITORGA.SetQuery(PPQRY_CAPUO2, 5, SQL, -1, "");
    PAN_SCELUNITORGA.SetQueryDB(PPQRY_CAPUO2, MainFrm.Cf4armDBObject.DB, 4);
    PAN_SCELUNITORGA.SetMasterTable(0, "CAP_UO");
