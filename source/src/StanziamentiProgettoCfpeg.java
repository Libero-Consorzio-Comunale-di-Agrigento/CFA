...
public final class StanziamentiProgettoCfpeg extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_STANZIPROGE4 = 0;
  ...
  {
    Init_TBL_PARAMETRI239(IMDB);
    //
    //
    Init_PQRY_STANZIPROGE4(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI239(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI239, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI239, "TBL_PARAMETRI239");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI239,IMDBDef1.FLD_PARAMETRI239_ROWNAMEPROID, "ROWNAMEPROID");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI239,IMDBDef1.FLD_PARAMETRI239_ROWNAMEPROID,5,9,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI239,IMDBDef1.FLD_PARAMETRI239_ROWNAMEES, "ROWNAMEES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI239,IMDBDef1.FLD_PARAMETRI239_ROWNAMEES,5,1,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI239, 0);
  }

  private static void Init_PQRY_STANZIPROGE4(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef8.PQRY_STANZIPROGE4, 6);
    IMDB.set_TblCode(IMDBDef8.PQRY_STANZIPROGE4, "PQRY_STANZIPROGE4");
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGCAPI, "STANPROGCAPI");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGCAPI,5,201,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STAPROSTAINI, "STAPROSTAINI");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STAPROSTAINI,2,19,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STAPROSTADEF, "STAPROSTADEF");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STAPROSTADEF,2,19,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGIMPE, "STANPROGIMPE");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGIMPE,2,19,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGDISP, "STANPROGDISP");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_STANPROGDISP,2,19,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_DES_VOCE, "DES_VOCE");
    IMDB.SetFldParams(IMDBDef8.PQRY_STANZIPROGE4,IMDBDef8.PQSL_STANZIPROGE4_DES_VOCE,5,140,0);
    IMDB.TblAddNew(IMDBDef8.PQRY_STANZIPROGE4, 0);
  }
  ...
  // **********************************************
  public StanziamentiProgettoCfpeg(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public StanziamentiProgettoCfpeg()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_STANPROGCFPE;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "C077C576-B098-44A2-B4E3-F3499C662141";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 772;
    DesignHeight = 402;
    set_Caption(new IDVariant("Stanziamenti Progetto Cfpeg"));
    //
    Frames = new AFrame[2];
    ...
    PAN_STANZIAMENTI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 772-MyGlb.PAN_OFFS_X, 376-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "B45D4DEF-07D6-4102-AD01-E4E469E0B046");
  ...
  {
    return (obj instanceof StanziamentiProgettoCfpeg);
  }
  ...
  {
    return (FullName ? StanziamentiProgettoCfpeg.class.getName() : (Glb.ClassWithPackage(StanziamentiProgettoCfpeg.class) ? StanziamentiProgettoCfpeg.class.getName().substring(StanziamentiProgettoCfpeg.class.getPackage().getName().length() + 1) : StanziamentiProgettoCfpeg.class.getName()));
  }
  ...
  private void PAN_STANZIAMENTI_DynamicProperties ()
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      PAN_STANZIAMENTI.set_ToolTip(Glb.OBJ_FIELD,PFL_STANZIAMENTI_DESCRIZIONE,IMDB.Value(IMDBDef8.PQRY_STANZIPROGE4, IMDBDef8.PQSL_STANZIPROGE4_DES_VOCE, 0).stringValue()); 
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("StanziamentiProgettoCfpeg", "StanziamentiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      TransCount = 0;
      v_INTESTAZIONE = (new IDVariant("Stanziamenti progetto del ", IDVariant.STRING));
      ...
      if (IMDB.Value(IMDBDef1.TBL_PARAMETRI239, IMDBDef1.FLD_PARAMETRI239_ROWNAMEES, 0).equals((new IDVariant("E")), true))
      {
    ...
    {
      MainFrm.ErrObj.ProcError ("StanziamentiProgettoCfpeg", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_STANZIAMENTI_Init()
  {
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_CAPITOLO, "0CEBE8D1-A0BA-41D6-9721-DA98AC539CCF");
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_DESCRIZIONE, "C7DE8012-B713-425E-9C5E-632C8552A465");
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_STANZINIZ, "1CBF7E27-E7F7-4C8D-8F8D-F858BA744EB7");
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_STANZDEF, "7F0BABA0-9B1C-4CA5-A4BA-34A096735372");
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_IMPEGNATO, "FB2EB08F-0945-43FC-99E1-C5F7B5342EFA");
    ...
    PAN_STANZIAMENTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_STANZIAMENTI_DISPONIBILIT, "743FE9B9-DE01-4F8C-996D-31DE0F5E5C7B");
  ...
  private void PAN_STANZIAMENTI_InitFields()
  {
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_CAPITOLO, PPQRY_STANZIPROGE4, "TO_CHAR ( A.CAPITOLO ) || ' / ' || TO_CHAR ( A.ARTICOLO )", "STANPROGCAPI", 5, 201, 0, -13997);
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_DESCRIZIONE, PPQRY_STANZIPROGE4, "A.DES_VOCE", "DES_VOCE", 5, 140, 0, -13997);
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_STANZINIZ, PPQRY_STANZIPROGE4, "NVL(A.STN_INI, 0) + NVL(A.VAR_INI, 0)", "STAPROSTAINI", 2, 19, 0, -13997);
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_STANZDEF, PPQRY_STANZIPROGE4, "NVL(A.STN_INI, 0) + NVL(A.VAR_INI, 0) + NVL(A.VAR_DEF, 0)", "STAPROSTADEF", 2, 19, 0, -13997);
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_IMPEGNATO, PPQRY_STANZIPROGE4, "(NVL(A.IMP_ACC, 0))", "STANPROGIMPE", 2, 19, 0, -13997);
    ...
    PAN_STANZIAMENTI.SetFieldPanel(PFL_STANZIAMENTI_DISPONIBILIT, PPQRY_STANZIPROGE4, "NVL(A.DISP, 0)", "STANPROGDISP", 2, 19, 0, -13997);
  }
  ...
  private void PAN_STANZIAMENTI_InitQueries()
  {
    ...
    PAN_STANZIAMENTI.SetIMDB(IMDB, "PQRY_STANZIPROGE4", true);
    ...
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  POL_DETTAGLIO_STN_PROG A ");
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.PROGETTO_ID = ~~TBL_PARAMETRI239.ROWNAMEPROID~~) ");
    SQL.append("and   (A.ESERCIZIO = ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (A.ESERCIZIO_STN = ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (A.E_S = ~~TBL_PARAMETRI239.ROWNAMEES~~) ");
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_STANZIAMENTI.SetQuery(PPQRY_STANZIPROGE4, 5, SQL, -1, "");
    PAN_STANZIAMENTI.SetQueryDB(PPQRY_STANZIPROGE4, MainFrm.Cf4armDBObject.DB, 4);
    PAN_STANZIAMENTI.SetMasterTable(0, "POL_DETTAGLIO_STN_PROG");
    //
