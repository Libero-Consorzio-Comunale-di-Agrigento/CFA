// **********************************************
// Aggiorna Tipo Avanzo Su Movimentazione
// Project : Cfa
// **********************************************
...
public final class AggiornaTipoAvanzoSuMovimentazione extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_NOTEFUNZIONA_ELABORA = 4;

  private static int PPQRY_NOTEFUNZIO12 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    //
    //
    Init_PQRY_NOTEFUNZIO12(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_PQRY_NOTEFUNZIO12(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef12.PQRY_NOTEFUNZIO12, 4);
    IMDB.set_TblCode(IMDBDef12.PQRY_NOTEFUNZIO12, "PQRY_NOTEFUNZIO12");
    IMDB.set_FldCode(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_MODULO, "MODULO");
    IMDB.SetFldParams(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_MODULO,5,20,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_PAGINA, "PAGINA");
    IMDB.SetFldParams(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_PAGINA,5,200,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_FUNZIONE, "FUNZIONE");
    IMDB.SetFldParams(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_FUNZIONE,5,200,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef12.PQRY_NOTEFUNZIO12,IMDBDef12.PQSL_NOTEFUNZIO12_DESCRIZIONE,9,9999,0);
    IMDB.TblAddNew(IMDBDef12.PQRY_NOTEFUNZIO12, 0);
  }
  ...
  // **********************************************
  public AggiornaTipoAvanzoSuMovimentazione(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public AggiornaTipoAvanzoSuMovimentazione()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_AGGTIPAVSUMO;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "25A7F1C9-93ED-4D04-B2C6-0F0D0EE6081D";
    ResModeW = 2;
    ResModeH = 2;
    iVisualFlags = -2049;
    DesignWidth = 476;
    DesignHeight = 254;
    set_Caption(new IDVariant("Aggiorna Tipo Avanzo Su Movimentazione"));
    //
    Frames = new AFrame[2];
    ...
    Frames[1].Caption = "NOTE FUNZIONALITA";
    Frames[1].Parent = this;
    Frames[1].FixedHeight = 228;
    PAN_NOTEFUNZIONA = new IDPanel(w, this, 1, "PAN_NOTEFUNZIONA");
    Frames[1].Content = PAN_NOTEFUNZIONA;
    PAN_NOTEFUNZIONA.set_VisualFlag(Glb.PANVISPROP_HILITEROW,true);
    PAN_NOTEFUNZIONA.VS = MainFrm.VisualStyleList;
    PAN_NOTEFUNZIONA.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 476-MyGlb.PAN_OFFS_X, 228-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "58C0F25B-D840-4195-BB9A-E714F990B728");
  ...
  {
    return (obj instanceof AggiornaTipoAvanzoSuMovimentazione);
  }
  ...
  {
    return (FullName ? AggiornaTipoAvanzoSuMovimentazione.class.getName() : (Glb.ClassWithPackage(AggiornaTipoAvanzoSuMovimentazione.class) ? AggiornaTipoAvanzoSuMovimentazione.class.getName().substring(AggiornaTipoAvanzoSuMovimentazione.class.getPackage().getName().length() + 1) : AggiornaTipoAvanzoSuMovimentazione.class.getName()));
  }
  ...
  public int Elabora ()
  {
    ...
    try
    {
      ...
      MainFrm.Cf4armDBObject.AGGIORNATIPOAVANZOMOV(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), (new IDVariant()));
      IDVariant v_VMSG = new IDVariant(0,IDVariant.STRING);
      v_VMSG = (new IDVariant("Elaborazione eseguita"));
    ...
    {
      MainFrm.ErrObj.ProcError ("AggiornaTipoAvanzoSuMovimentazione", "Elabora", _e);
      return -1;
    }
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("AggiornaTipoAvanzoSuMovimentazione", "Unload", _e);
    }
  }
  ...
  {
    int i = 0;
    if (ColIndex.intValue() == PFL_NOTEFUNZIONA_ELABORA)
    {
      this.IdxPanelActived = this.PAN_NOTEFUNZIONA.FrIndex;
  ...
  private void PAN_NOTEFUNZIONA_Init()
  {
    ...
    PAN_NOTEFUNZIONA.SetSize(MyGlb.OBJ_FIELD, 5);
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_MODULO, "12DEE7B0-B568-4F98-A22B-86E8E1BA3057");
    ...
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_PAGINA, "228522AB-B9E4-447E-810F-61161C8C924B");
    ...
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_FUNZIONE, "6F66762B-5C23-42B0-ACC4-20FD6314FE47");
    ...
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_DESCRIZIONE, "37939F28-9F16-4BE6-89F9-F4FFCEC18D62");
    ...
    PAN_NOTEFUNZIONA.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, "9F96AEC8-9871-4063-ACBA-C95D75DE416B");
    PAN_NOTEFUNZIONA.set_Header(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, "Elabora");
    PAN_NOTEFUNZIONA.set_VisualStyle(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.VIS_STATICBUTTON);
    PAN_NOTEFUNZIONA.SetImage(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, 0, "button1.gif", false);
    PAN_NOTEFUNZIONA.SetFlags(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_INFORM | MyGlb.FLD_CANACTIVATE, -1);
  }
  ...
  private void PAN_NOTEFUNZIONA_InitFields()
  {
    ...
    PAN_NOTEFUNZIONA.SetFieldPanel(PFL_NOTEFUNZIONA_MODULO, PPQRY_NOTEFUNZIO12, "A.MODULO", "MODULO", 5, 20, 0, -13997);
    ...
    PAN_NOTEFUNZIONA.SetFieldPanel(PFL_NOTEFUNZIONA_PAGINA, PPQRY_NOTEFUNZIO12, "A.PAGINA", "PAGINA", 5, 200, 0, -13997);
    ...
    PAN_NOTEFUNZIONA.SetFieldPanel(PFL_NOTEFUNZIONA_FUNZIONE, PPQRY_NOTEFUNZIO12, "A.FUNZIONE", "FUNZIONE", 5, 200, 0, -13997);
    ...
    PAN_NOTEFUNZIONA.SetRect(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_DESCRIZIONE, MyGlb.PANEL_FORM, 24, 4, 420, 112, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    PAN_NOTEFUNZIONA.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_DESCRIZIONE, MyGlb.PANEL_FORM, 96);
    PAN_NOTEFUNZIONA.SetNumRow(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_DESCRIZIONE, MyGlb.PANEL_FORM, 8);
    ...
    PAN_NOTEFUNZIONA.SetFieldPanel(PFL_NOTEFUNZIONA_DESCRIZIONE, PPQRY_NOTEFUNZIO12, "A.DESCRIZIONE", "DESCRIZIONE", 9, 9999, 0, -13997);
    PAN_NOTEFUNZIONA.SetRect(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_LIST, 588, 120, 120, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_NOTEFUNZIONA.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_LIST, 0);
    PAN_NOTEFUNZIONA.SetNumRow(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_LIST, 1);
    PAN_NOTEFUNZIONA.SetRect(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_FORM, 24, 140, 80, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_NOTEFUNZIONA.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_FORM, 0);
    PAN_NOTEFUNZIONA.SetNumRow(MyGlb.OBJ_FIELD, PFL_NOTEFUNZIONA_ELABORA, MyGlb.PANEL_FORM, 1);
    PAN_NOTEFUNZIONA.SetFieldPage(PFL_NOTEFUNZIONA_ELABORA, -1, -1);
    PAN_NOTEFUNZIONA.SetFieldPanel(PFL_NOTEFUNZIONA_ELABORA, -1, "", "ELABORA", 0, 0, 0, -13997);
  }
  ...
  private void PAN_NOTEFUNZIONA_InitQueries()
  {
    ...
    PAN_NOTEFUNZIONA.SetIMDB(IMDB, "PQRY_NOTEFUNZIO12", true);
    ...
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  NOTE_FUNZIONALITA A ");
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.MODULO = ~~TBL_DATISESSIONE.SESSIOMODULO~~) ");
    SQL.append("and   (A.PAGINA = 'Aggiorna Tipo Avanzo su Movimentazione') ");
    SQL.append("and   (A.FUNZIONE = 'Descrizione') ");
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_NOTEFUNZIONA.SetQuery(PPQRY_NOTEFUNZIO12, 5, SQL, -1, "");
    PAN_NOTEFUNZIONA.SetQueryDB(PPQRY_NOTEFUNZIO12, MainFrm.Cf4armDBObject.DB, 4);
