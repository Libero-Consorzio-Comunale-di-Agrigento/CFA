...
public final class SceltaVociEconomiche extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_VOCIECONOMI2 = 0;
  ...
  {
    Init_TBL_PARAMETRI453(IMDB);
    //
    //
    Init_PQRY_VOCIECONOMI2(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI453(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI453, 1);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI453, "TBL_PARAMETRI453");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI453,IMDBDef1.FLD_PARAMETRI453_PARAMES, "PARAMES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI453,IMDBDef1.FLD_PARAMETRI453_PARAMES,5,1,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI453, 0);
  }

  private static void Init_PQRY_VOCIECONOMI2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_VOCIECONOMI2, 3);
    IMDB.set_TblCode(IMDBDef7.PQRY_VOCIECONOMI2, "PQRY_VOCIECONOMI2");
    IMDB.set_FldCode(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_E_S, "E_S");
    IMDB.SetFldParams(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_E_S,5,1,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_CODICE, "CODICE");
    IMDB.SetFldParams(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_CODICE,1,2,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_VOCIECONOMI2,IMDBDef7.PQSL_VOCIECONOMI2_DESCRIZIONE,5,140,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_VOCIECONOMI2, 0);
  }
  ...
  // **********************************************
  public SceltaVociEconomiche(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELVOCIECON;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "3DE93D83-7D22-4D68-9229-CDB00F9B5FA7";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 568;
    DesignHeight = 362;
    set_Caption(new IDVariant("Scelta Voci Economiche"));
    //
    Frames = new AFrame[2];
    ...
    PAN_VOCIECONOMIC.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 568-MyGlb.PAN_OFFS_X, 336-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "0D188368-01A3-469E-B8F5-72DA07DC99D3");
  ...
  {
    return (obj instanceof SceltaVociEconomiche);
  }
  ...
  {
    return (FullName ? SceltaVociEconomiche.class.getName() : (Glb.ClassWithPackage(SceltaVociEconomiche.class) ? SceltaVociEconomiche.class.getName().substring(SceltaVociEconomiche.class.getPackage().getName().length() + 1) : SceltaVociEconomiche.class.getName()));
  }
  ...
  private void PAN_VOCIECONOMIC_DynamicProperties ()
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      PAN_VOCIECONOMIC.set_ToolTip(Glb.OBJ_FIELD,PFL_VOCIECONOMIC_DESCRIZIONE,IMDB.Value(IMDBDef7.PQRY_VOCIECONOMI2, IMDBDef7.PQSL_VOCIECONOMI2_DESCRIZIONE, 0).stringValue()); 
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SceltaVociEconomiche", "VociEconomicheOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaVociEconomiche", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_VOCIECONOMIC_Init()
  {
    ...
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIECONOMIC_CODICE, "81B7BDB5-808C-4AEE-B966-983635D7DC65");
    ...
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIECONOMIC_DESCRIZIONE, "5A9EFE77-8847-45F7-9001-D341CB738EF2");
  ...
  private void PAN_VOCIECONOMIC_InitFields()
  {
    ...
    PAN_VOCIECONOMIC.SetFieldPanel(PFL_VOCIECONOMIC_CODICE, PPQRY_VOCIECONOMI2, "A.CODICE", "CODICE", 1, 2, 0, -13997);
    ...
    PAN_VOCIECONOMIC.SetFieldPanel(PFL_VOCIECONOMIC_DESCRIZIONE, PPQRY_VOCIECONOMI2, "A.DESCRIZIONE", "DESCRIZIONE", 5, 140, 0, -13997);
  }
  ...
  private void PAN_VOCIECONOMIC_InitQueries()
  {
    ...
    PAN_VOCIECONOMIC.SetIMDB(IMDB, "PQRY_VOCIECONOMI2", true);
    ...
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  VOCI_ECONOMICHE A ");
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.E_S = ~~TBL_PARAMETRI453.PARAMES~~) ");
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMI2, 5, SQL, -1, "");
    PAN_VOCIECONOMIC.SetQueryDB(PPQRY_VOCIECONOMI2, MainFrm.Cf4armDBObject.DB, 4);
