...
public final class SceltaPolProgetti extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_PROGETTI1 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    ...
    //
    //
    Init_PQRY_PROGETTI1(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_IN16(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_IN16, 1);
    IMDB.set_TblCode(IMDBDef1.TBL_IN16, "TBL_IN16");
    IMDB.set_FldCode(IMDBDef1.TBL_IN16,IMDBDef1.FLD_IN16_ROWNAMEPROUO, "ROWNAMEPROUO");
    IMDB.SetFldParams(IMDBDef1.TBL_IN16,IMDBDef1.FLD_IN16_ROWNAMEPROUO,1,8,0);
    IMDB.TblAddNew(IMDBDef1.TBL_IN16, 0);
  }

  private static void Init_PQRY_PROGETTI1(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_PROGETTI1, 3);
    IMDB.set_TblCode(IMDBDef7.PQRY_PROGETTI1, "PQRY_PROGETTI1");
    IMDB.set_FldCode(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_CODICE, "CODICE");
    IMDB.SetFldParams(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_CODICE,5,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_DESCRIZIONE,5,100,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_PROGETTO_ID, "PROGETTO_ID");
    IMDB.SetFldParams(IMDBDef7.PQRY_PROGETTI1,IMDBDef7.PQSL_PROGETTI1_PROGETTO_ID,5,9,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_PROGETTI1, 0);
  }
  ...
  // **********************************************
  public SceltaPolProgetti(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELTPOLPROG;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "A225ECA3-22CE-44A0-861A-A840510D399B";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 548;
    DesignHeight = 410;
    set_Caption(new IDVariant("Scelta Pol Progetti"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PROGETTI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 548-MyGlb.PAN_OFFS_X, 384-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "E15B0AF1-EBB9-4370-BD8A-E6834F146B81");
    PAN_PROGETTI.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 508, 256, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  {
    return (obj instanceof SceltaPolProgetti);
  }
  ...
  {
    return (FullName ? SceltaPolProgetti.class.getName() : (Glb.ClassWithPackage(SceltaPolProgetti.class) ? SceltaPolProgetti.class.getName().substring(SceltaPolProgetti.class.getPackage().getName().length() + 1) : SceltaPolProgetti.class.getName()));
  }
  ...
  private void PAN_PROGETTI_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaPolProgetti", "ProgettiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    int ReturnStatus = 0;
    IDCachedRowSet QV;
    IDVariant v_SCEL = new IDVariant(0,IDVariant.STRING);

    try
    {
      TransCount = 0;
      v_SCEL = (new IDVariant("Scelta Progetti", IDVariant.STRING));
      MainFrm.IntFormLoad(this);
      // 
      // Load Event Body
      // Procedure Body
      // 
      set_Caption(new IDVariant(v_SCEL));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SceltaPolProgetti", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_PROGETTI_Init()
  {
    ...
    PAN_PROGETTI.SetSize(MyGlb.OBJ_FIELD, 2);
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PROGETTI_PROGETTO, "2C0268C0-D18B-47A7-905A-C529806DF2AE");
    ...
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PROGETTI_DESCRIZIONE, "6767CF42-71BF-42E3-B18C-7B7E0A926033");
  ...
  private void PAN_PROGETTI_InitFields()
  {
    ...
    StringBuffer SQL = new StringBuffer();
    PAN_PROGETTI.SetRect(MyGlb.OBJ_FIELD, PFL_PROGETTI_PROGETTO, MyGlb.PANEL_LIST, 0, 36, 76, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PROGETTI.SetRect(MyGlb.OBJ_FIELD, PFL_PROGETTI_PROGETTO, MyGlb.PANEL_FORM, 4, 52, 136, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PROGETTI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PROGETTI_PROGETTO, MyGlb.PANEL_FORM, 76);
    ...
    PAN_PROGETTI.SetFieldPanel(PFL_PROGETTI_PROGETTO, PPQRY_PROGETTI1, "A.PROGETTO_ID", "PROGETTO_ID", 5, 9, 0, -13997);
    PAN_PROGETTI.SetRect(MyGlb.OBJ_FIELD, PFL_PROGETTI_DESCRIZIONE, MyGlb.PANEL_LIST, 76, 36, 432, 20, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_NONE);
    ...
    PAN_PROGETTI.SetRect(MyGlb.OBJ_FIELD, PFL_PROGETTI_DESCRIZIONE, MyGlb.PANEL_FORM, 4, 28, 588, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PROGETTI.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PROGETTI_DESCRIZIONE, MyGlb.PANEL_FORM, 76);
    ...
    PAN_PROGETTI.SetFieldPanel(PFL_PROGETTI_DESCRIZIONE, PPQRY_PROGETTI1, "A.DESCRIZIONE", "DESCRIZIONE", 5, 100, 0, -13997);
  }
  ...
  private void PAN_PROGETTI_InitQueries()
  {
    ...
    PAN_PROGETTI.SetIMDB(IMDB, "PQRY_PROGETTI1", true);
    ...
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  PROGETTI A, ");
    SQL.append("  PROGETTI_UO B ");
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (B.PROGETTO_ID = A.PROGETTO_ID) ");
    SQL.append("and   ((B.SCADENZA IS NULL) OR B.SCADENZA > TRUNC( SYSDATE )) ");
    SQL.append("and   (B.PROGR_UNITA_ORGANIZZATIVA = ~~TBL_IN16.ROWNAMEPROUO~~) ");
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.PROGETTO_ID ");
    PAN_PROGETTI.SetQuery(PPQRY_PROGETTI1, 5, SQL, -1, "");
    PAN_PROGETTI.SetQueryDB(PPQRY_PROGETTI1, MainFrm.Cf4armDBObject.DB, 4);
