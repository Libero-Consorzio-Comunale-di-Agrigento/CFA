...
public final class FinanziamentiImpFin extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_IMPFIN4 = 0;
  ...
  {
    Init_TBL_PARAMETRI381(IMDB);
    //
    //
    Init_PQRY_IMPFIN4(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI381(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI381, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI381, "TBL_PARAMETRI381");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI381,IMDBDef1.FLD_PARAMETRI381_PARAMANNOIMP, "PARAMANNOIMP");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI381,IMDBDef1.FLD_PARAMETRI381_PARAMANNOIMP,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI381,IMDBDef1.FLD_PARAMETRI381_PARAMNUMEIMP, "PARAMNUMEIMP");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI381,IMDBDef1.FLD_PARAMETRI381_PARAMNUMEIMP,1,5,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI381, 0);
  }

  private static void Init_PQRY_IMPFIN4(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_IMPFIN4, 2);
    IMDB.set_TblCode(IMDBDef7.PQRY_IMPFIN4, "PQRY_IMPFIN4");
    IMDB.set_FldCode(IMDBDef7.PQRY_IMPFIN4,IMDBDef7.PQSL_IMPFIN4_FINANZIAMENTO, "FINANZIAMENTO");
    IMDB.SetFldParams(IMDBDef7.PQRY_IMPFIN4,IMDBDef7.PQSL_IMPFIN4_FINANZIAMENTO,1,5,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_IMPFIN4,IMDBDef7.PQSL_IMPFIN4_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_IMPFIN4,IMDBDef7.PQSL_IMPFIN4_DESCRIZIONE,5,200,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_IMPFIN4, 0);
  }
  ...
  // **********************************************
  public FinanziamentiImpFin(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_FINANZIMPFIN;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "0A4A3990-697E-4431-961E-5F9BA8FF4E8A";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 712;
    DesignHeight = 422;
    set_Caption(new IDVariant("Finanziamenti Imp Fin"));
    //
    Frames = new AFrame[2];
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 712-MyGlb.PAN_OFFS_X, 396-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "3C4588CA-AA84-424E-AE30-BB12D5370B63");
  ...
  {
    return (obj instanceof FinanziamentiImpFin);
  }
  ...
  {
    return (FullName ? FinanziamentiImpFin.class.getName() : (Glb.ClassWithPackage(FinanziamentiImpFin.class) ? FinanziamentiImpFin.class.getName().substring(FinanziamentiImpFin.class.getPackage().getName().length() + 1) : FinanziamentiImpFin.class.getName()));
  }
  ...
  private void PAN_FINANZIAMENT_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("FinanziamentiImpFin", "FinanziamentiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("FinanziamentiImpFin", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_FINANZIAMENT_Init()
  {
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_FINANZIAMENT, "B4B1B939-4F98-4A6D-A0B2-768AF0DC1373");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, "351AE840-3941-41F6-B573-F449033DC131");
  ...
  private void PAN_FINANZIAMENT_InitFields()
  {
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_FINANZIAMENT, PPQRY_IMPFIN4, "A.FINANZIAMENTO", "FINANZIAMENTO", 1, 5, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_DESCRIZIONE, PPQRY_IMPFIN4, "B.DESCRIZIONE", "DESCRIZIONE", 5, 200, 0, -13997);
  }
  ...
  private void PAN_FINANZIAMENT_InitQueries()
  {
    ...
    PAN_FINANZIAMENT.SetIMDB(IMDB, "PQRY_IMPFIN4", true);
    ...
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  IMP_FIN A, ");
    SQL.append("  FINANZIAMENTI B ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ANNO_IMP = ~~TBL_PARAMETRI381.PARAMANNOIMP~~) ");
    SQL.append("and   (A.NUMERO_IMP = ~~TBL_PARAMETRI381.PARAMNUMEIMP~~) ");
    SQL.append("and   (A.FINANZIAMENTO = B.CODICE) ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 4, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_IMPFIN4, 5, SQL, -1, "");
    PAN_FINANZIAMENT.SetQueryDB(PPQRY_IMPFIN4, MainFrm.Cf4armDBObject.DB, 4);
