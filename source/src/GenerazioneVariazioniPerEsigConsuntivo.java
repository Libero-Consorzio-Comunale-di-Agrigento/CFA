// **********************************************
// Generazione Variazioni Per Esig Consuntivo
// Project : Cfa
// **********************************************
...
public final class GenerazioneVariazioniPerEsigConsuntivo extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_PARS73 = 0;
  ...
  {
    Init_TBL_PARS31(IMDB);
    //
    //
    Init_PQRY_PARS73(IMDB);
    Init_PQRY_PARS73_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS31(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef4.TBL_PARS31, 7);
    IMDB.set_TblCode(IMDBDef4.TBL_PARS31, "TBL_PARS31");
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEPROP, "NOMEOGGEPROP");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEPROP,5,255,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGENUME, "NOMEOGGENUME");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGENUME,1,4,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEANNO, "NOMEOGGEANNO");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEANNO,1,4,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEDESC, "NOMEOGGEDESC");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMEOGGEDESC,5,140,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMOGGDATREG, "NOMOGGDATREG");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMOGGDATREG,6,14,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOOGCOANCOAN, "NOOGCOANCOAN");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOOGCOANCOAN,5,10,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMOGGTIPVAR, "NOMOGGTIPVAR");
    IMDB.SetFldParams(IMDBDef4.TBL_PARS31,IMDBDef4.FLD_PARS31_NOMOGGTIPVAR,1,2,0);
    IMDB.TblAddNew(IMDBDef4.TBL_PARS31, 0);
  }

  private static void Init_PQRY_PARS73(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef12.PQRY_PARS73, 6);
    IMDB.set_TblCode(IMDBDef12.PQRY_PARS73, "PQRY_PARS73");
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, "NOMEOGGEPROP");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEPROP,5,255,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGENUME, "NOMEOGGENUME");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGENUME,1,4,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, "NOMEOGGEANNO");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEANNO,1,4,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, "NOMEOGGEDESC");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMEOGGEDESC,5,140,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMOGGDATREG, "NOMOGGDATREG");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMOGGDATREG,6,14,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, "NOMOGGTIPVAR");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73,IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR,1,2,0);
    IMDB.TblAddNew(IMDBDef12.PQRY_PARS73, 0);
  }

  private static void Init_PQRY_PARS73_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef12.PQRY_PARS73_RS, 6);
    IMDB.set_TblCode(IMDBDef12.PQRY_PARS73_RS, "PQRY_PARS73_RS");
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, "NOMEOGGEPROP");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEPROP,5,255,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGENUME, "NOMEOGGENUME");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGENUME,1,4,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, "NOMEOGGEANNO");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEANNO,1,4,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, "NOMEOGGEDESC");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMEOGGEDESC,5,140,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMOGGDATREG, "NOMOGGDATREG");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMOGGDATREG,6,14,0);
    IMDB.set_FldCode(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, "NOMOGGTIPVAR");
    IMDB.SetFldParams(IMDBDef12.PQRY_PARS73_RS,IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR,1,2,0);
  }
  ...
  // **********************************************
  public GenerazioneVariazioniPerEsigConsuntivo(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public GenerazioneVariazioniPerEsigConsuntivo()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_GENVARPEESCO;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "25BBE946-6927-4B1F-97EA-A4D262750F49";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 460;
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "81A77109-5D96-40CE-91F8-818DAF9BF5BF");
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef4.TBL_PARS31, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        GENVARPEESCO_PARS73();
      }
  ...
  {
    return (obj instanceof GenerazioneVariazioniPerEsigConsuntivo);
  }
  ...
  {
    return (FullName ? GenerazioneVariazioniPerEsigConsuntivo.class.getName() : (Glb.ClassWithPackage(GenerazioneVariazioniPerEsigConsuntivo.class) ? GenerazioneVariazioniPerEsigConsuntivo.class.getName().substring(GenerazioneVariazioniPerEsigConsuntivo.class.getPackage().getName().length() + 1) : GenerazioneVariazioniPerEsigConsuntivo.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEPROP, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGENUME, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEANNO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEDESC, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMOGGDATREG, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOOGCOANCOAN, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMOGGTIPVAR, 0, new IDVariant());
  }
  ...
  private void IntEndModal(IDVariant LookupForm,IDVariant Result,IDVariant Cancel)
  {
    ...
    try
    {
      ...
      if (Result.booleanValue())
      {
        ...
        {
          IMDB.set_Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0, IMDB.Value(IMDBDef7.PQRY_PROPOSTE1, IMDBDef7.PQSL_PROPOSTE1_UNITA_PROPONENTE, 0));
          IMDB.set_Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0, IMDB.Value(IMDBDef7.PQRY_PROPOSTE1, IMDBDef7.PQSL_PROPOSTE1_NUMERO, 0));
          IMDB.set_Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0, IMDB.Value(IMDBDef7.PQRY_PROPOSTE1, IMDBDef7.PQSL_PROPOSTE1_ANNO, 0));
        }
      }
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "EndModal", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      IMDB.set_Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMOGGDATREG, 0, IDL.Today());
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "Load", _e);
    }
  }
  ...
  private void PAN_GENERAVARIAZ_OnUpdatingRow(IDVariant Column, IDVariant FieldModified, IDVariant FieldWasModified, IDVariant RowWasModified, IDVariant Inserting, IDVariant Cancel)
  {
    ...
    try
    {
      ...
      if (Column.equals((new IDVariant(PFL_GENERAVARIAZ_PROPOSTA)), true))
      {
        ...
        {
          if (!(IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0))))
          {
            IMDB.set_Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0, IDL.Upper(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0)));
          }
        }
      }
      if (Column.equals((new IDVariant(PFL_GENERAVARIAZ_DATAREG)), true) && FieldWasModified.booleanValue())
      {
        if (!(IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0))))
        {
          if (IDL.Year(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0)).compareTo(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), true)!=0)
          {
            ...
            IMDB.set_Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0, IDL.Today());
          }
        }
      }
    }
    ...
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "GenerazioneVariazioniOnUpdatingRow", _e);
    }
  }
  ...
  public int InfoProposta ()
  {
    ...
    try
    {
      ...
      // Corpo Procedura
      // 
      if (!(IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0))) && !(IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0))) && !(IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0))))
      {
        IMDB.set_Value(IMDBDef1.TBL_PARAMETRI7, IMDBDef1.FLD_PARAMETRI7_ROWNAMEUNITA, 0, IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0));
        IMDB.set_Value(IMDBDef1.TBL_PARAMETRI7, IMDBDef1.FLD_PARAMETRI7_ROWNAMENUMER, 0, IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0));
        IMDB.set_Value(IMDBDef1.TBL_PARAMETRI7, IMDBDef1.FLD_PARAMETRI7_ROWNAMEANNO, 0, IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0));
    ...
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "InfoProposta", _e);
      return -1;
    }
  }
  ...
  public int EtichettaSceltaProp ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "EtichettaSceltaProp", _e);
      return -1;
    }
  }
  ...
  public int EtichettaElabora ()
  {
    ...
    try
    {
      ...
      if (IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, 0)))
      {
        IDVariant S = new IDVariant(0,IDVariant.STRING);
      ...
      if (IDL.IsNull(IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, 0)))
      {
        IDVariant S = null;
      ...
      if (IMDB.Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOOGCOANCOAN, 0).equals((new IDVariant("C")), true))
      {
        MainFrm.Cf4armDBObject.GENERAVARCOMPROESIGCONS(MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0), IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSUSERNAME, 0));
      }
      else if (IMDB.Value(IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOOGCOANCOAN, 0).equals((new IDVariant("A")), true))
      {
        MainFrm.Cf4armDBObject.GENERAVARCOMPROESIGCORR(MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0), IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSUSERNAME, 0));
      }
      else
      {
        // 
        // = ""
        // 
        MainFrm.Cf4armDBObject.GENERAVARCOMPROESIGANTIC(MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEDESC, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGTIPVAR, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEPROP, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGENUME, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMEOGGEANNO, 0), IMDB.Value(IMDBDef12.PQRY_PARS73, IMDBDef12.PQSL_PARS73_NOMOGGDATREG, 0), IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSUSERNAME, 0));
      }
    ...
    {
      MainFrm.ErrObj.ProcError ("GenerazioneVariazioniPerEsigConsuntivo", "EtichettaElabora", _e);
      return -1;
    }
  }
  ...
  // **********************************************************************
  private void GENVARPEESCO_PARS73() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef12.PQRY_PARS73_RS);
    IMDB.TblMoveFirst(IMDBDef4.TBL_PARS31, 0);
    Loop1: while (!IMDB.Eof(IMDBDef4.TBL_PARS31, 0))
    {
      IMDB.TblAddNew(IMDBDef12.PQRY_PARS73_RS, 0);
      IMDB.TblLinkRow(IMDBDef12.PQRY_PARS73_RS, 0, IMDBDef4.TBL_PARS31, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 0, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEPROP, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 1, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGENUME, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 2, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEANNO, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 3, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMEOGGEDESC, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 4, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMOGGDATREG, 0);
      IMDB.TblLinkField(IMDBDef12.PQRY_PARS73_RS, 5, 0, IMDBDef4.TBL_PARS31, IMDBDef4.FLD_PARS31_NOMOGGTIPVAR, 0);
      IMDB.TblMoveNext(IMDBDef4.TBL_PARS31, 0);
      if (IMDB.Eof(IMDBDef4.TBL_PARS31, 0))
      {
        IMDB.TblMoveFirst(IMDBDef4.TBL_PARS31, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef12.PQRY_PARS73_RS, 0);
  }
  ...
  private void PAN_GENERAVARIAZ_Init()
  {
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_PROPOSTA, "4114175A-6BB2-4373-8556-801F27D8205C");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_NUMERO, "4CAA2229-C87F-4DCD-8FED-B451AD2CCBB4");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_ANNO, "D4FF60EE-691D-4B83-8BDA-CCFBBAEA25A4");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_ETICSCELPROP, "4BCFC581-B6D2-4381-B7FC-D4FD6B315838");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_INFOPROP, "D2A22D29-3283-4D2E-83B9-07A304B37203");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_DESCRIZIONE, "A73EE927-1943-4376-82C3-C5A161D936C9");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_DATAREG, "608D4FED-19A9-45DD-8EFA-65D28D1ED36E");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_ETICHEELABOR, "66A93B0A-D877-403F-84B3-AB81811FE363");
    ...
    PAN_GENERAVARIAZ.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_GENERAVARIAZ_TIPOVARIAZIO, "D4D4B07A-21CB-45A9-A01E-F8D3E364D478");
  ...
  private void PAN_GENERAVARIAZ_InitFields()
  {
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_PROPOSTA, PPQRY_PARS73, "A.NOMEOGGEPROP", "NOMEOGGEPROP", 5, 255, 0, -13997);
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_NUMERO, PPQRY_PARS73, "A.NOMEOGGENUME", "NOMEOGGENUME", 1, 4, 0, -13997);
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_ANNO, PPQRY_PARS73, "A.NOMEOGGEANNO", "NOMEOGGEANNO", 1, 4, 0, -13997);
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_DESCRIZIONE, PPQRY_PARS73, "A.NOMEOGGEDESC", "NOMEOGGEDESC", 5, 140, 0, -13997);
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_DATAREG, PPQRY_PARS73, "A.NOMOGGDATREG", "NOMOGGDATREG", 6, 14, 0, -13997);
    ...
    PAN_GENERAVARIAZ.SetFieldPanel(PFL_GENERAVARIAZ_TIPOVARIAZIO, PPQRY_PARS73, "A.NOMOGGTIPVAR", "NOMOGGTIPVAR", 1, 2, 0, -13997);
  }
  ...
  private void PAN_GENERAVARIAZ_InitQueries()
  {
    ...
    PAN_GENERAVARIAZ.SetIMDB(IMDB, "PQRY_PARS73", true);
    PAN_GENERAVARIAZ.set_SetString(MyGlb.MASTER_ROWNAME, "Nome Oggetto");
    PAN_GENERAVARIAZ.SetQueryIMDB(PPQRY_PARS73, IMDBDef12.PQRY_PARS73_RS, IMDBDef4.TBL_PARS31);
    JustLoaded = true;
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_PROPOSTA, IMDBDef4.FLD_PARS31_NOMEOGGEPROP);
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_NUMERO, IMDBDef4.FLD_PARS31_NOMEOGGENUME);
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_ANNO, IMDBDef4.FLD_PARS31_NOMEOGGEANNO);
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_DESCRIZIONE, IMDBDef4.FLD_PARS31_NOMEOGGEDESC);
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_DATAREG, IMDBDef4.FLD_PARS31_NOMOGGDATREG);
    PAN_GENERAVARIAZ.SetFieldPrimaryIndex(PFL_GENERAVARIAZ_TIPOVARIAZIO, IMDBDef4.FLD_PARS31_NOMOGGTIPVAR);
    PAN_GENERAVARIAZ.SetMasterTable(0, "PARS31");
    //
