...
public final class ElencoFinanziamenti extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_FINANZIAMENT_NUMEROMUTUO = 3;
  private static int PFL_FINANZIAMENT_ANNOMUTUO = 4;
  private static int PFL_FINANZIAMENT_CATEGORIA = 5;
  private static int PFL_FINANZIAMENT_SCADENZA = 6;

  private static int PPQRY_FINANZIAME24 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    //
    //
    Init_PQRY_FINANZIAME24(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_PQRY_FINANZIAME24(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_FINANZIAME24, 7);
    IMDB.set_TblCode(IMDBDef7.PQRY_FINANZIAME24, "PQRY_FINANZIAME24");
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZCODICE, "FINANZCODICE");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZCODICE,1,5,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZDESCRI, "FINANZDESCRI");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZDESCRI,5,200,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINAANNOMUTU, "FINAANNOMUTU");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINAANNOMUTU,1,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANUMEMUTU, "FINANUMEMUTU");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANUMEMUTU,5,10,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZSCADEN, "FINANZSCADEN");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZSCADEN,1,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZCATEGO, "FINANZCATEGO");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FINANZCATEGO,5,99,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FIBERASOESES, "FIBERASOESES");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME24,IMDBDef7.PQSL_FINANZIAME24_FIBERASOESES,5,60,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_FINANZIAME24, 0);
  }
  ...
  // **********************************************
  public ElencoFinanziamenti(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_ELENCOFINANZ;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "8D104746-CBA0-45BB-B45C-AE2585C6CD4B";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 788;
    DesignHeight = 394;
    set_Caption(new IDVariant("Elenco Finanziamenti"));
    //
    Frames = new AFrame[2];
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 788-MyGlb.PAN_OFFS_X, 368-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "20566724-DD8D-4613-BA85-865F1F80EEED");
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 1084, 236, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  {
    return (obj instanceof ElencoFinanziamenti);
  }
  ...
  {
    return (FullName ? ElencoFinanziamenti.class.getName() : (Glb.ClassWithPackage(ElencoFinanziamenti.class) ? ElencoFinanziamenti.class.getName().substring(ElencoFinanziamenti.class.getPackage().getName().length() + 1) : ElencoFinanziamenti.class.getName()));
  }
  ...
  private void PAN_FINANZIAMENT_DynamicProperties ()
  {
    ...
    try
    {
      ...
      // Corpo Procedura
      // 
      PAN_FINANZIAMENT.set_ToolTip(Glb.OBJ_FIELD,PFL_FINANZIAMENT_ENTE,IMDB.Value(IMDBDef7.PQRY_FINANZIAME24, IMDBDef7.PQSL_FINANZIAME24_FIBERASOESES, 0).stringValue()); 
      PAN_FINANZIAMENT.set_ToolTip(Glb.OBJ_FIELD,PFL_FINANZIAMENT_DESCRIZIONE,IMDB.Value(IMDBDef7.PQRY_FINANZIAME24, IMDBDef7.PQSL_FINANZIAME24_FINANZDESCRI, 0).stringValue()); 
      PAN_FINANZIAMENT.set_ToolTip(Glb.OBJ_FIELD,PFL_FINANZIAMENT_CATEGORIA,IMDB.Value(IMDBDef7.PQRY_FINANZIAME24, IMDBDef7.PQSL_FINANZIAME24_FINANZCATEGO, 0).stringValue()); 
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("ElencoFinanziamenti", "FinanziamentiOnDynamicProperties", _e);
    }
  }
  ...
  private void PAN_FINANZIAMENT_Init()
  {
    ...
    PAN_FINANZIAMENT.SetSize(MyGlb.OBJ_FIELD, 7);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CODICE, "94BAEE88-FD02-4412-A592-49B4402726E0");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, "56657DF6-7292-4BE9-891C-0DF41CE15C49");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, "E30DEDA6-E62D-4195-8D18-A51E3429B14E");
    ...
    PAN_FINANZIAMENT.SetFlags(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, 0 | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM, -1);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, "47E1237C-3C15-40F0-921B-D4E35E198CAA");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ANNOMUTUO, "0D5DE459-26CC-455A-A306-C79BF7F1F5BE");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, "7D850435-10ED-4A7F-BF31-05BCA8E925DB");
    ...
    PAN_FINANZIAMENT.SetFlags(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, 0 | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_ISOPT, -1);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_SCADENZA, "9D928A3E-E88A-4E29-8117-72DF1D3E0C1B");
  ...
  private void PAN_FINANZIAMENT_InitFields()
  {
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CODICE, MyGlb.PANEL_FORM, 4, 4, 152, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_CODICE, PPQRY_FINANZIAME24, "A.CODICE", "FINANZCODICE", 1, 5, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, MyGlb.PANEL_LIST, 56, 36, 268, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, MyGlb.PANEL_FORM, 4, 28, 496, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_DESCRIZIONE, PPQRY_FINANZIAME24, "A.DESCRIZIONE", "FINANZDESCRI", 5, 200, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, MyGlb.PANEL_LIST, 324, 36, 244, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, MyGlb.PANEL_LIST, 108);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, MyGlb.PANEL_FORM, 4, 256, 320, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, MyGlb.PANEL_FORM, 108);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_ENTE, PPQRY_FINANZIAME24, "C.RAGIONE_SOCIALE_ESTESA", "FIBERASOESES", 5, 60, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, MyGlb.PANEL_LIST, 568, 36, 92, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, MyGlb.PANEL_LIST, 100);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, MyGlb.PANEL_FORM, 4, 112, 164, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, MyGlb.PANEL_FORM, 100);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_NUMEROMUTUO, PPQRY_FINANZIAME24, "A.NUMERO_MUTUO", "FINANUMEMUTU", 5, 10, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ANNOMUTUO, MyGlb.PANEL_LIST, 660, 36, 84, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ANNOMUTUO, MyGlb.PANEL_FORM, 4, 88, 128, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_ANNOMUTUO, PPQRY_FINANZIAME24, "A.ANNO_MUTUO", "FINAANNOMUTU", 1, 4, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, MyGlb.PANEL_LIST, 744, 36, 276, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, MyGlb.PANEL_LIST, 92);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, MyGlb.PANEL_FORM, 4, 208, 524, 44, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_FINANZIAMENT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, MyGlb.PANEL_FORM, 92);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_CATEGORIA, PPQRY_FINANZIAME24, "CASE WHEN (A.CATEGORIA IS NULL) THEN '(nulla)' ELSE TO_CHAR ( A.CATEGORIA ) || ' - ' || B.DESCRIZIONE END", "FINANZCATEGO", 5, 99, 0, -13997);
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_SCADENZA, MyGlb.PANEL_LIST, 1020, 36, 64, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_SCADENZA, MyGlb.PANEL_FORM, 4, 160, 112, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_SCADENZA, PPQRY_FINANZIAME24, "A.SCADENZA", "FINANZSCADEN", 1, 4, 0, -13997);
  }
  ...
  private void PAN_FINANZIAMENT_InitQueries()
  {
    ...
    PAN_FINANZIAMENT.SetIMDB(IMDB, "PQRY_FINANZIAME24", true);
    ...
    SQL.append("  A.NUMERO_MUTUO as FINANUMEMUTU, ");
    ...
    SQL.append("  C.RAGIONE_SOCIALE_ESTESA as FIBERASOESES ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  FINANZIAMENTI A, ");
    SQL.append("  CATEGORIE_FIN B, ");
    SQL.append("  BEN C ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.CATEGORIA = B.CODICE(+)) ");
    SQL.append("and   ((A.SCADENZA IS NULL) OR A.SCADENZA >= ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (A.ENTE = C.CODICE(+)) ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME24, 5, SQL, -1, "");
    PAN_FINANZIAMENT.SetQueryDB(PPQRY_FINANZIAME24, MainFrm.Cf4armDBObject.DB, 4);
