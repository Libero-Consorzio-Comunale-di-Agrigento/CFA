...
{  
  ...
  private void PAN_PARAMETRI_Init()
  {
    ...
    PAN_PARAMETRI.set_Header(MyGlb.OBJ_FIELD, PFL_PARAMETRI_ETICHEINTEST, "Confermi la produzione del file excel per comunicare lo scaduto a PCC  relativamente ai documenti di cui si è comunicato a PCC la contabilizzazione e per cui non si è ancora comunicato l’intero pagamento?\n<br/><br/>\nVengono inclusi nel file Excel i documenti la cui scadenza è diversa da quella precedentemente comunicata con la contabilizzazione.");
