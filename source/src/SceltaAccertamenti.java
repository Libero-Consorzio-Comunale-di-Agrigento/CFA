...
public final class SceltaAccertamenti extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_ESEACC1 = 0;
  ...
  {
    Init_TBL_PARAMETRI96(IMDB);
    //
    //
    Init_PQRY_ESEACC1(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI96(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI96, 2);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI96, "TBL_PARAMETRI96");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI96,IMDBDef1.FLD_PARAMETRI96_ROWNAMPROUNI, "ROWNAMPROUNI");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI96,IMDBDef1.FLD_PARAMETRI96_ROWNAMPROUNI,1,5,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI96,IMDBDef1.FLD_PARAMETRI96_ROWNAMEESERC, "ROWNAMEESERC");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI96,IMDBDef1.FLD_PARAMETRI96_ROWNAMEESERC,1,5,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI96, 0);
  }

  private static void Init_PQRY_ESEACC1(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_ESEACC1, 7);
    IMDB.set_TblCode(IMDBDef7.PQRY_ESEACC1, "PQRY_ESEACC1");
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ANNO_ACC, "ANNO_ACC");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ANNO_ACC,1,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_NUMERO_ACC, "NUMERO_ACC");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_NUMERO_ACC,1,5,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_CAPITOLO, "CAPITOLO");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_CAPITOLO,3,16,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ARTICOLO, "ARTICOLO");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ARTICOLO,1,2,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_DESCRIZIONE,5,140,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ESEACUOUTILI, "ESEACUOUTILI");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_ESEACUOUTILI,5,99,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_DISPONIBILITA, "DISPONIBILITA");
    IMDB.SetFldParams(IMDBDef7.PQRY_ESEACC1,IMDBDef7.PQSL_ESEACC1_DISPONIBILITA,3,14,2);
    IMDB.TblAddNew(IMDBDef7.PQRY_ESEACC1, 0);
  }
  ...
  // **********************************************
  public SceltaAccertamenti(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELTAACCERT;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "800FB46F-D564-43B2-AC8E-14BBCD4803F8";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 816;
    DesignHeight = 402;
    set_Caption(new IDVariant("Scelta Accertamenti"));
    //
    Frames = new AFrame[2];
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "224EB350-355C-43B6-A977-1DF522CC0C30");
  ...
  {
    return (obj instanceof SceltaAccertamenti);
  }
  ...
  {
    return (FullName ? SceltaAccertamenti.class.getName() : (Glb.ClassWithPackage(SceltaAccertamenti.class) ? SceltaAccertamenti.class.getName().substring(SceltaAccertamenti.class.getPackage().getName().length() + 1) : SceltaAccertamenti.class.getName()));
  }
  ...
  private void PAN_SCELTAACCERT_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamenti", "SceltaAccertamentiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamenti", "LoadEvent", _e);
    }
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      IMDB.set_Value(IMDBDef1.TBL_PARAMETRI96, IMDBDef1.FLD_PARAMETRI96_ROWNAMEESERC, 0, (new IDVariant()));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamenti", "UnloadEvent", _e);
    }
  }
  ...
  public int InfoAccertamenti ()
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      IMDB.set_Value(IMDBDef4.TBL_PARAMETRI82, IMDBDef4.FLD_PARAMETRI82_PARAMNUMEACC, 0, IMDB.Value(IMDBDef7.PQRY_ESEACC1, IMDBDef7.PQSL_ESEACC1_NUMERO_ACC, 0));
      IMDB.set_Value(IMDBDef4.TBL_PARAMETRI82, IMDBDef4.FLD_PARAMETRI82_PARAMANNOACC, 0, IMDB.Value(IMDBDef7.PQRY_ESEACC1, IMDBDef7.PQSL_ESEACC1_ANNO_ACC, 0));
      MainFrm.Show(MyGlb.FRM_INFOACCEFORM, (new IDVariant(-1)).intValue(), this); 
      return 0;
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamenti", "InfoAccertamenti", _e);
      return -1;
    }
  }
  ...
  private void PAN_SCELTAACCERT_Init()
  {
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_NUMERO, "0221DDA9-E6FC-4238-9261-DD94F7CAA97A");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ANNO, "0358F48E-E0DE-40B8-8E8F-73B8ECC267B7");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_INFOACCERTAM, "92FFAF59-57D0-4FF5-8048-2D1FD228DE58");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ACCERTALABEL, "221D3DAD-A8B0-448B-BEF7-7F88DB3C7C21");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_DESCRIZIONE, "6E3CE54A-458C-4979-9C0F-A18A3E3C9C3E");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_CAPITOLO, "E80097A8-3ADD-4F5F-A956-A492CF6357F8");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ART, "244EED75-8C9A-4EB7-B215-005345069A6C");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_UOUTILIZZO, "689AAFB2-837F-4948-BB80-BEF2E4CDAC02");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_DISPONIBILIT, "7FA9DEC5-97CD-49FF-A0DC-B73EA159C49C");
  ...
  private void PAN_SCELTAACCERT_InitFields()
  {
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_NUMERO, PPQRY_ESEACC1, "A.NUMERO_ACC", "NUMERO_ACC", 1, 5, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_ANNO, PPQRY_ESEACC1, "A.ANNO_ACC", "ANNO_ACC", 1, 4, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_DESCRIZIONE, PPQRY_ESEACC1, "B.DESCRIZIONE", "DESCRIZIONE", 5, 140, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_CAPITOLO, PPQRY_ESEACC1, "A.CAPITOLO", "CAPITOLO", 3, 16, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_ART, PPQRY_ESEACC1, "A.ARTICOLO", "ARTICOLO", 1, 2, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_UOUTILIZZO, PPQRY_ESEACC1, "DECODE(GET_UO_UTILIZZO(A.ESERCIZIO,'E',A.CAPITOLO,A.ARTICOLO,TRUNC( SYSDATE )), to_number(NULL), NULL, SO4_UTIL.UNITA_GET_DESCR_VALIDA(GET_UO_UTILIZZO(A.ESERCIZIO,'E',A.CAPITOLO,A.ARTICOLO,TRUNC( SYSDATE )),TRUNC( SYSDATE )))", "ESEACUOUTILI", 5, 99, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_DISPONIBILIT, PPQRY_ESEACC1, "A.DISPONIBILITA", "DISPONIBILITA", 3, 14, 2, -13997);
  }
  ...
  private void PAN_SCELTAACCERT_InitQueries()
  {
    ...
    PAN_SCELTAACCERT.SetIMDB(IMDB, "PQRY_ESEACC1", true);
    ...
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  ESEACC A, ");
    SQL.append("  ACC B ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ESERCIZIO = ~~TBL_PARAMETRI96.ROWNAMEESERC~~) ");
    SQL.append("and   (B.ANNO_ACC = A.ANNO_ACC) ");
    SQL.append("and   (B.NUMERO_ACC = A.NUMERO_ACC) ");
    SQL.append("and   (NVL(B.PROGR_UNITA_ORGANIZZATIVA, -1) = NVL(~~TBL_PARAMETRI96.ROWNAMPROUNI~~, NVL(B.PROGR_UNITA_ORGANIZZATIVA, -1))) ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.ANNO_ACC, ");
    SQL.append("  A.NUMERO_ACC ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_ESEACC1, 5, SQL, -1, "");
    PAN_SCELTAACCERT.SetQueryDB(PPQRY_ESEACC1, MainFrm.Cf4armDBObject.DB, 4);
