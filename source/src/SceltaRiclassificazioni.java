...
public final class SceltaRiclassificazioni extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_VISTSTRURIC2 = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    ...
    //
    //
    Init_PQRY_VISTSTRURIC2(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS8(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARS8, 5);
    IMDB.set_TblCode(IMDBDef1.TBL_PARS8, "TBL_PARS8");
    IMDB.set_FldCode(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMOGGCOTIRI, "NOMOGGCOTIRI");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMOGGCOTIRI,5,10,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGETTES, "NOMEOGGETTES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGETTES,5,1,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGELIVE, "NOMEOGGELIVE");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGELIVE,1,2,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGEESER, "NOMEOGGEESER");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGEESER,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGELIV4, "NOMEOGGELIV4");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS8,IMDBDef1.FLD_PARS8_NOMEOGGELIV4,3,10,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARS8, 0);
  }

  private static void Init_PQRY_VISTSTRURIC2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_VISTSTRURIC2, 2);
    IMDB.set_TblCode(IMDBDef7.PQRY_VISTSTRURIC2, "PQRY_VISTSTRURIC2");
    IMDB.set_FldCode(IMDBDef7.PQRY_VISTSTRURIC2,IMDBDef7.PQSL_VISTSTRURIC2_VISSTRRICCOD, "VISSTRRICCOD");
    IMDB.SetFldParams(IMDBDef7.PQRY_VISTSTRURIC2,IMDBDef7.PQSL_VISTSTRURIC2_VISSTRRICCOD,1,10,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_VISTSTRURIC2,IMDBDef7.PQSL_VISTSTRURIC2_VISSTRRICDES, "VISSTRRICDES");
    IMDB.SetFldParams(IMDBDef7.PQRY_VISTSTRURIC2,IMDBDef7.PQSL_VISTSTRURIC2_VISSTRRICDES,5,300,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_VISTSTRURIC2, 0);
  }
  ...
  // **********************************************
  public SceltaRiclassificazioni(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SceltaRiclassificazioni()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELTARICLAS;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "DE10A0D6-6781-4895-9E6D-1A0E99FE0902";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 640;
    DesignHeight = 370;
    set_Caption(new IDVariant("Scelta Riclassificazioni"));
    //
    Frames = new AFrame[2];
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "B94E4F09-9EB9-474B-AF40-B6BF79C77708");
  ...
  {
    return (obj instanceof SceltaRiclassificazioni);
  }
  ...
  {
    return (FullName ? SceltaRiclassificazioni.class.getName() : (Glb.ClassWithPackage(SceltaRiclassificazioni.class) ? SceltaRiclassificazioni.class.getName().substring(SceltaRiclassificazioni.class.getPackage().getName().length() + 1) : SceltaRiclassificazioni.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaRiclassificazioni", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef1.TBL_PARS8, IMDBDef1.FLD_PARS8_NOMOGGCOTIRI, 0, new IDVariant());
    IMDB.set_Value(IMDBDef1.TBL_PARS8, IMDBDef1.FLD_PARS8_NOMEOGGETTES, 0, new IDVariant());
    IMDB.set_Value(IMDBDef1.TBL_PARS8, IMDBDef1.FLD_PARS8_NOMEOGGELIVE, 0, new IDVariant());
    IMDB.set_Value(IMDBDef1.TBL_PARS8, IMDBDef1.FLD_PARS8_NOMEOGGEESER, 0, new IDVariant());
  ...
  private void PAN_VISTSTRURICL_Init()
  {
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_CODICE, "31603094-CE60-42D9-ABD2-1C3EEB3FF88E");
    ...
    PAN_VISTSTRURICL.SetFlags(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_CODICE, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_VERTHDRLIST, -1);
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_DESCRIZIONE, "82F97F37-82D0-4ABD-831B-679692C566B4");
    ...
    PAN_VISTSTRURICL.SetFlags(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_DESCRIZIONE, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_LISTLIST | MyGlb.FLD_INLIST | MyGlb.FLD_INFORM | MyGlb.FLD_VERTHDRLIST, -1);
  }
  ...
  private void PAN_VISTSTRURICL_InitFields()
  {
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_CODICE, PPQRY_VISTSTRURIC2, "A.CODICE", "VISSTRRICCOD", 1, 10, 0, -13997);
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_DESCRIZIONE, PPQRY_VISTSTRURIC2, "A.DESCRIZIONE", "VISSTRRICDES", 5, 300, 0, -13997);
  }
  ...
  private void PAN_VISTSTRURICL_InitQueries()
  {
    ...
    PAN_VISTSTRURICL.SetIMDB(IMDB, "PQRY_VISTSTRURIC2", true);
    ...
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  VISTA_STRUTTURA_RICL A ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.CODICE_TIPO_RICL = ~~TBL_PARS8.NOMOGGCOTIRI~~) ");
    SQL.append("and   (A.E_S = ~~TBL_PARS8.NOMEOGGETTES~~) ");
    SQL.append("and   (A.LIVELLO = ~~TBL_PARS8.NOMEOGGELIVE~~) ");
    SQL.append("and   (NVL(A.ESERCIZIO_INIZIO, 0) <= ~~TBL_PARS8.NOMEOGGEESER~~) ");
    SQL.append("and   (A.ESERCIZIO_SCADENZA >= ~~TBL_PARS8.NOMEOGGEESER~~) ");
    SQL.append("and   ((NVL(~~TBL_PARS8.NOMEOGGELIV4~~, 0) = 0 OR A.CODICE_PADRE = ~~TBL_PARS8.NOMEOGGELIV4~~)) ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC2, 5, SQL, -1, "");
    PAN_VISTSTRURICL.SetQueryDB(PPQRY_VISTSTRURIC2, MainFrm.Cf4armDBObject.DB, 4);
    PAN_VISTSTRURICL.SetMasterTable(0, "VISTA_STRUTTURA_RICL");
    PAN_VISTSTRURICL.AddToSortList(PFL_VISTSTRURICL_CODICE, true);
    //
