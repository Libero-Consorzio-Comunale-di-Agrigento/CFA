// **********************************************
// Scelta Accertamenti Per Funzioni Accertamenti
// Project : Cfa
// **********************************************
...
public final class SceltaAccertamentiPerFunzioniAccertamenti extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_SCELTAACCERT_ART = 4;

  private static int PPQRY_VISTAACCUOU2 = 0;
  ...
  {
    Init_TBL_PARAMETRI205(IMDB);
    //
    //
    Init_PQRY_VISTAACCUOU2(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI205(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef4.TBL_PARAMETRI205, 2);
    IMDB.set_TblCode(IMDBDef4.TBL_PARAMETRI205, "TBL_PARAMETRI205");
    IMDB.set_FldCode(IMDBDef4.TBL_PARAMETRI205,IMDBDef4.FLD_PARAMETRI205_ROWNAMPROUNI, "ROWNAMPROUNI");
    IMDB.SetFldParams(IMDBDef4.TBL_PARAMETRI205,IMDBDef4.FLD_PARAMETRI205_ROWNAMPROUNI,1,5,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PARAMETRI205,IMDBDef4.FLD_PARAMETRI205_ROWNAMEESERC, "ROWNAMEESERC");
    IMDB.SetFldParams(IMDBDef4.TBL_PARAMETRI205,IMDBDef4.FLD_PARAMETRI205_ROWNAMEESERC,1,5,0);
    IMDB.TblAddNew(IMDBDef4.TBL_PARAMETRI205, 0);
  }

  private static void Init_PQRY_VISTAACCUOU2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef14.PQRY_VISTAACCUOU2, 5);
    IMDB.set_TblCode(IMDBDef14.PQRY_VISTAACCUOU2, "PQRY_VISTAACCUOU2");
    IMDB.set_FldCode(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_ANNO_ACC, "ANNO_ACC");
    IMDB.SetFldParams(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_ANNO_ACC,1,4,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_NUMERO_ACC, "NUMERO_ACC");
    IMDB.SetFldParams(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_NUMERO_ACC,1,5,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_CAPITOLO, "CAPITOLO");
    IMDB.SetFldParams(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_CAPITOLO,3,16,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_ARTICOLO, "ARTICOLO");
    IMDB.SetFldParams(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_ARTICOLO,1,2,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef14.PQRY_VISTAACCUOU2,IMDBDef14.PQSL_VISTAACCUOU2_DESCRIZIONE,5,140,0);
    IMDB.TblAddNew(IMDBDef14.PQRY_VISTAACCUOU2, 0);
  }
  ...
  // **********************************************
  public SceltaAccertamentiPerFunzioniAccertamenti(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SceltaAccertamentiPerFunzioniAccertamenti()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCEACCPEFUAC;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "7AF2E48B-280D-4D2B-BC71-259F1AB8B866";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 644;
    DesignHeight = 422;
    set_Caption(new IDVariant("Scelta Accertamenti Per Funzioni Accertamenti"));
    //
    Frames = new AFrame[2];
    ...
    PAN_SCELTAACCERT.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 644-MyGlb.PAN_OFFS_X, 396-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "861550EB-0840-437C-9943-D31F6EFCAA93");
    PAN_SCELTAACCERT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 580, 236, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  {
    return (obj instanceof SceltaAccertamentiPerFunzioniAccertamenti);
  }
  ...
  {
    return (FullName ? SceltaAccertamentiPerFunzioniAccertamenti.class.getName() : (Glb.ClassWithPackage(SceltaAccertamentiPerFunzioniAccertamenti.class) ? SceltaAccertamentiPerFunzioniAccertamenti.class.getName().substring(SceltaAccertamentiPerFunzioniAccertamenti.class.getPackage().getName().length() + 1) : SceltaAccertamentiPerFunzioniAccertamenti.class.getName()));
  }
  ...
  private void PAN_SCELTAACCERT_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamentiPerFunzioniAccertamenti", "SceltaAccertamentiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      TransCount = 0;
      v_CAPTION = (new IDVariant("Scelta Accertamenti", IDVariant.STRING));
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaAccertamentiPerFunzioniAccertamenti", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_SCELTAACCERT_Init()
  {
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ANNO, "38857748-8B66-48C6-AC81-60C5B370CBE7");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_NUMERO, "BA43DF04-E81E-4469-9E5C-039EA3908BD1");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_DESCRIZIONE, "F113F3FE-EF85-42A8-A644-EE1DF7A20A4C");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_CAPITOLO, "91B5F798-BE16-404F-9F30-EA3F1EC46ED7");
    ...
    PAN_SCELTAACCERT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ART, "AEB2B935-ACA1-4B05-8233-921A9CA7B122");
  ...
  private void PAN_SCELTAACCERT_InitFields()
  {
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_ANNO, PPQRY_VISTAACCUOU2, "A.ANNO_ACC", "ANNO_ACC", 1, 4, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_NUMERO, PPQRY_VISTAACCUOU2, "A.NUMERO_ACC", "NUMERO_ACC", 1, 5, 0, -13997);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_DESCRIZIONE, PPQRY_VISTAACCUOU2, "B.DESCRIZIONE", "DESCRIZIONE", 5, 140, 0, -13997);
    PAN_SCELTAACCERT.SetRect(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_CAPITOLO, MyGlb.PANEL_LIST, 428, 36, 116, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_CAPITOLO, PPQRY_VISTAACCUOU2, "A.CAPITOLO", "CAPITOLO", 3, 16, 0, -13997);
    PAN_SCELTAACCERT.SetRect(MyGlb.OBJ_FIELD, PFL_SCELTAACCERT_ART, MyGlb.PANEL_LIST, 544, 36, 36, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_SCELTAACCERT.SetFieldPanel(PFL_SCELTAACCERT_ART, PPQRY_VISTAACCUOU2, "A.ARTICOLO", "ARTICOLO", 1, 2, 0, -13997);
  }
  ...
  private void PAN_SCELTAACCERT_InitQueries()
  {
    ...
    PAN_SCELTAACCERT.SetIMDB(IMDB, "PQRY_VISTAACCUOU2", true);
    ...
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  ESEACC A, ");
    SQL.append("  ACC B ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ESERCIZIO = ~~TBL_PARAMETRI205.ROWNAMEESERC~~) ");
    SQL.append("and   (B.ANNO_ACC(+) = A.ANNO_ACC) ");
    SQL.append("and   (B.NUMERO_ACC(+) = A.NUMERO_ACC) ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.ANNO_ACC, ");
    SQL.append("  A.NUMERO_ACC ");
    PAN_SCELTAACCERT.SetQuery(PPQRY_VISTAACCUOU2, 5, SQL, -1, "");
    PAN_SCELTAACCERT.SetQueryDB(PPQRY_VISTAACCUOU2, MainFrm.Cf4armDBObject.DB, 4);
