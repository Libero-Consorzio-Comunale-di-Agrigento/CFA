// **********************************************
// Parametri Generazione Impegni Da Cronoprogramma
// Project : Cfa
// **********************************************
...
public final class ParametriGenerazioneImpegniDaCronoprogramma extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_PAR119 = 0;
  ...
  {
    Init_TBL_PAR126(IMDB);
    //
    //
    Init_PQRY_PAR119(IMDB);
    Init_PQRY_PAR119_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PAR126(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef4.TBL_PAR126, 1);
    IMDB.set_TblCode(IMDBDef4.TBL_PAR126, "TBL_PAR126");
    IMDB.set_FldCode(IMDBDef4.TBL_PAR126,IMDBDef4.FLD_PAR126_NOMEOGGEDELI, "NOMEOGGEDELI");
    IMDB.SetFldParams(IMDBDef4.TBL_PAR126,IMDBDef4.FLD_PAR126_NOMEOGGEDELI,5,1,0);
    IMDB.TblAddNew(IMDBDef4.TBL_PAR126, 0);
  }

  private static void Init_PQRY_PAR119(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef13.PQRY_PAR119, 1);
    IMDB.set_TblCode(IMDBDef13.PQRY_PAR119, "PQRY_PAR119");
    IMDB.set_FldCode(IMDBDef13.PQRY_PAR119,IMDBDef13.PQSL_PAR119_NOMEOGGEDELI, "NOMEOGGEDELI");
    IMDB.SetFldParams(IMDBDef13.PQRY_PAR119,IMDBDef13.PQSL_PAR119_NOMEOGGEDELI,5,1,0);
    IMDB.TblAddNew(IMDBDef13.PQRY_PAR119, 0);
  }

  private static void Init_PQRY_PAR119_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef13.PQRY_PAR119_RS, 1);
    IMDB.set_TblCode(IMDBDef13.PQRY_PAR119_RS, "PQRY_PAR119_RS");
    IMDB.set_FldCode(IMDBDef13.PQRY_PAR119_RS,IMDBDef13.PQSL_PAR119_NOMEOGGEDELI, "NOMEOGGEDELI");
    IMDB.SetFldParams(IMDBDef13.PQRY_PAR119_RS,IMDBDef13.PQSL_PAR119_NOMEOGGEDELI,5,1,0);
  }
  ...
  // **********************************************
  public ParametriGenerazioneImpegniDaCronoprogramma(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public ParametriGenerazioneImpegniDaCronoprogramma()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_PARGENIMDACR;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "05AAE5DA-2195-44EE-BA2A-9BC2D85D2248";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 324;
    ...
    PAN_PAR.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "40D41963-9642-46A1-9D10-08B4F822A4F3");
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef4.TBL_PAR126, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        PARGENIMDACR_PAR119();
      }
  ...
  {
    return (obj instanceof ParametriGenerazioneImpegniDaCronoprogramma);
  }
  ...
  {
    return (FullName ? ParametriGenerazioneImpegniDaCronoprogramma.class.getName() : (Glb.ClassWithPackage(ParametriGenerazioneImpegniDaCronoprogramma.class) ? ParametriGenerazioneImpegniDaCronoprogramma.class.getName().substring(ParametriGenerazioneImpegniDaCronoprogramma.class.getPackage().getName().length() + 1) : ParametriGenerazioneImpegniDaCronoprogramma.class.getName()));
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("ParametriGenerazioneImpegniDaCronoprogramma", "Load", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef4.TBL_PAR126, IMDBDef4.FLD_PAR126_NOMEOGGEDELI, 0, new IDVariant());
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      {
        if (IDL.IsNull(IMDB.Value(IMDBDef13.PQRY_PAR119, IMDBDef13.PQSL_PAR119_NOMEOGGEDELI, 0)))
        {
    ...
    {
      MainFrm.ErrObj.ProcError ("ParametriGenerazioneImpegniDaCronoprogramma", "Unload", _e);
    }
  }
  ...
  public int EtichettaElabora ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("ParametriGenerazioneImpegniDaCronoprogramma", "EtichettaElabora", _e);
      return -1;
    }
  }
  ...
  // **********************************************************************
  private void PARGENIMDACR_PAR119() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef13.PQRY_PAR119_RS);
    IMDB.TblMoveFirst(IMDBDef4.TBL_PAR126, 0);
    Loop1: while (!IMDB.Eof(IMDBDef4.TBL_PAR126, 0))
    {
      IMDB.TblAddNew(IMDBDef13.PQRY_PAR119_RS, 0);
      IMDB.TblLinkRow(IMDBDef13.PQRY_PAR119_RS, 0, IMDBDef4.TBL_PAR126, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PAR119_RS, 0, 0, IMDBDef4.TBL_PAR126, IMDBDef4.FLD_PAR126_NOMEOGGEDELI, 0);
      IMDB.TblMoveNext(IMDBDef4.TBL_PAR126, 0);
      if (IMDB.Eof(IMDBDef4.TBL_PAR126, 0))
      {
        IMDB.TblMoveFirst(IMDBDef4.TBL_PAR126, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef13.PQRY_PAR119_RS, 0);
  }
  ...
  private void PAN_PAR_Init()
  {
    ...
    PAN_PAR.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PAR_DELIBERA, "F392AC7B-1E90-4CBE-AB15-DD44A301093F");
    ...
    PAN_PAR.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PAR_ETICHEELABOR, "B0500811-B5F7-4F41-8D7C-5BC7CA95F6BD");
  ...
  private void PAN_PAR_InitFields()
  {
    ...
    PAN_PAR.SetFieldPanel(PFL_PAR_DELIBERA, PPQRY_PAR119, "A.NOMEOGGEDELI", "NOMEOGGEDELI", 5, 1, 0, -13997);
  ...
  private void PAN_PAR_InitQueries()
  {
    ...
    PAN_PAR.SetIMDB(IMDB, "PQRY_PAR119", true);
    PAN_PAR.set_SetString(MyGlb.MASTER_ROWNAME, "Nome Oggetto");
    PAN_PAR.SetQueryIMDB(PPQRY_PAR119, IMDBDef13.PQRY_PAR119_RS, IMDBDef4.TBL_PAR126);
    JustLoaded = true;
    PAN_PAR.SetFieldPrimaryIndex(PFL_PAR_DELIBERA, IMDBDef4.FLD_PAR126_NOMEOGGEDELI);
    PAN_PAR.SetMasterTable(0, "PAR126");
    //
