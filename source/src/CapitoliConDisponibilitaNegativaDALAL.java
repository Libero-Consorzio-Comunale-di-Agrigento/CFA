// **********************************************
// Capitoli Con Disponibilita Negativa DAL AL
// Project : Cfa
// **********************************************
...
public final class CapitoliConDisponibilitaNegativaDALAL extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_BIL8 = 0;
  ...
  // IMDB DDL Procedures
  private static void Init_TBL_PARS48(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef5.TBL_PARS48, 6);
    IMDB.set_TblCode(IMDBDef5.TBL_PARS48, "TBL_PARS48");
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETDAL, "NOMEOGGETDAL");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETDAL,1,5,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETTAL, "NOMEOGGETTAL");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETTAL,1,5,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETTES, "NOMEOGGETTES");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGETTES,5,1,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMOGGCADINE, "NOMOGGCADINE");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMOGGCADINE,1,12,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGEVPRO, "NOMEOGGEVPRO");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGEVPRO,5,2,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGSOLEM, "NOMEOGGSOLEM");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS48,IMDBDef5.FLD_PARS48_NOMEOGGSOLEM,5,2,0);
    IMDB.TblAddNew(IMDBDef5.TBL_PARS48, 0);
  }

  private static void Init_PQRY_BIL8(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef14.PQRY_BIL8, 5);
    IMDB.set_TblCode(IMDBDef14.PQRY_BIL8, "PQRY_BIL8");
    IMDB.set_FldCode(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_RECORBILCAPI, "RECORBILCAPI");
    IMDB.SetFldParams(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_RECORBILCAPI,3,16,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_RECORBILARTI, "RECORBILARTI");
    IMDB.SetFldParams(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_RECORBILARTI,1,2,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_TOTALEIMPORT, "TOTALEIMPORT");
    IMDB.SetFldParams(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_TOTALEIMPORT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_DISPONIBILIT, "DISPONIBILIT");
    IMDB.SetFldParams(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_DISPONIBILIT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_VARPROVVISOR, "VARPROVVISOR");
    IMDB.SetFldParams(IMDBDef14.PQRY_BIL8,IMDBDef14.PQSL_BIL8_VARPROVVISOR,3,28,6);
    IMDB.TblAddNew(IMDBDef14.PQRY_BIL8, 0);
  }
  ...
  // **********************************************
  public CapitoliConDisponibilitaNegativaDALAL(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public CapitoliConDisponibilitaNegativaDALAL()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_CACODINEDAAL;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "79F7EEC5-BC26-4F2D-8A39-8CC03BE0EA59";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 792;
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "710ED8B5-3FAE-4AAE-84BF-F3160D5175FC");
  ...
  {
    return (obj instanceof CapitoliConDisponibilitaNegativaDALAL);
  }
  ...
  {
    return (FullName ? CapitoliConDisponibilitaNegativaDALAL.class.getName() : (Glb.ClassWithPackage(CapitoliConDisponibilitaNegativaDALAL.class) ? CapitoliConDisponibilitaNegativaDALAL.class.getName().substring(CapitoliConDisponibilitaNegativaDALAL.class.getPackage().getName().length() + 1) : CapitoliConDisponibilitaNegativaDALAL.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      // IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMOGGCADINE, 0, new IDVariant(I));
      // IDVariant v_COMMIT = new IDVariant(0,IDVariant.INTEGER);
      // if (IMDB.Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMOGGCADINE, 0).equals((new IDVariant(0)), true))
      // {
    ...
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaDALAL", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGETDAL, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGETTAL, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGETTES, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMOGGCADINE, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGEVPRO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGSOLEM, 0, new IDVariant());
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      QV.Close();
      if (IDL.NullValue(IMDB.Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGSOLEM, 0),(new IDVariant("NO"))).equals((new IDVariant("NO")), true))
      {
        IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGEVPRO, 0, ((!(IDL.IsNull(v_VT99COCAVPLI)))?(new IDVariant("SI")):(new IDVariant("NO"))));
      }
      else
      {
        IMDB.set_Value(IMDBDef5.TBL_PARS48, IMDBDef5.FLD_PARS48_NOMEOGGEVPRO, 0, (new IDVariant("NO")));
      }
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaDALAL", "Load", _e);
    }
  }
  ...
  private void PAN_CAPITOLI_Init()
  {
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_CAPITOLO, "1255A89A-9B4C-443F-B30A-DF17958757BF");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_ARTICOLO, "A32805A2-B3F7-48A8-9B73-75CC0FB31C33");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_TOTALEIMPORT, "79F7A204-CA45-4174-917F-6D1AE8CAF49C");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DISPONIBILIT, "0B7DE82B-B98C-454B-9860-C35F4C3A5406");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_VARPROVVISOR, "5A0A7BCB-52B8-4BE0-B46B-E4B806E43EC4");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DUALDISPRISU, "BC44A029-9EA2-4016-A521-21401A9007CF");
  ...
  private void PAN_CAPITOLI_InitFields()
  {
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_CAPITOLO, PPQRY_BIL8, "C.CAPITOLO", "RECORBILCAPI", 3, 16, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_ARTICOLO, PPQRY_BIL8, "C.ARTICOLO", "RECORBILARTI", 1, 2, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_TOTALEIMPORT, PPQRY_BIL8, "SUM(B.IMPORTO)", "TOTALEIMPORT", 3, 28, 6, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_DISPONIBILIT, PPQRY_BIL8, "MAX(C.DISPONIBILITA_CA)", "DISPONIBILIT", 3, 28, 6, -13997);
  ...
  SQL.append("))");
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_VARPROVVISOR, PPQRY_BIL8, SQL.toString(), "VARPROVVISOR", 3, 28, 6, -13997);
  ...
  private void PAN_CAPITOLI_InitQueries()
  {
    ...
    PAN_CAPITOLI.SetIMDB(IMDB, "PQRY_BIL8", true);
    ...
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  LIQ B, ");
    SQL.append("  BIL C ");
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 1, SQL, -1, "");
    SQL = new StringBuffer();
    ...
    SQL.append("and   ((B.NUMERO_LIQ BETWEEN ~~TBL_PARS48.NOMEOGGETDAL~~ AND ~~TBL_PARS48.NOMEOGGETTAL~~)) ");
    SQL.append("and   (B.ANNO_LIQ = C.ESERCIZIO) ");
    SQL.append("and   (CONTROLLO_DISP_CASSA_VPRO_CAP(C.ESERCIZIO,C.CAPITOLO,C.ARTICOLO,CASE WHEN ~~TBL_PARS48.NOMEOGGEVPRO~~ = 'SI' THEN 'LI' ELSE 'EM' END) < 0) ");
    SQL.append("and   (~~TBL_PARS48.NOMEOGGEVPRO~~ = 'SI' OR (~~TBL_PARS48.NOMEOGGEVPRO~~ = 'NO' AND NOT ((B.ANNO_MAND IS NULL)))) ");
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 2, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("group by ");
    SQL.append("  C.CAPITOLO, ");
    SQL.append("  C.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  C.CAPITOLO, ");
    SQL.append("  C.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_BIL8, 5, SQL, -1, "");
    PAN_CAPITOLI.SetQueryDB(PPQRY_BIL8, MainFrm.Cf4armDBObject.DB, 4);
