...
public final class VociEconomiche extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_VOCIECONOMIC = 0;
  ...
  public static void ImdbInit(IMDBObj IMDB)
  {
    //
    //
    Init_PQRY_VOCIECONOMIC(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_PQRY_VOCIECONOMIC(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef10.PQRY_VOCIECONOMIC, 2);
    IMDB.set_TblCode(IMDBDef10.PQRY_VOCIECONOMIC, "PQRY_VOCIECONOMIC");
    IMDB.set_FldCode(IMDBDef10.PQRY_VOCIECONOMIC,IMDBDef10.PQSL_VOCIECONOMIC_CODICE, "CODICE");
    IMDB.SetFldParams(IMDBDef10.PQRY_VOCIECONOMIC,IMDBDef10.PQSL_VOCIECONOMIC_CODICE,1,2,0);
    IMDB.set_FldCode(IMDBDef10.PQRY_VOCIECONOMIC,IMDBDef10.PQSL_VOCIECONOMIC_RECORDDESCRI, "RECORDDESCRI");
    IMDB.SetFldParams(IMDBDef10.PQRY_VOCIECONOMIC,IMDBDef10.PQSL_VOCIECONOMIC_RECORDDESCRI,5,99,0);
    IMDB.TblAddNew(IMDBDef10.PQRY_VOCIECONOMIC, 0);
  }
  ...
  // **********************************************
  public VociEconomiche(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_VOCIECONOMIC;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "6D1CB39F-1733-41FE-9F6C-3135E2EC8B55";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 556;
    ...
    PAN_VOCIECONOMIC.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 556-MyGlb.PAN_OFFS_X, 340-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "6429FAD0-8D16-4811-8791-18723E44C2A4");
  ...
  {
    return (obj instanceof VociEconomiche);
  }
  ...
  {
    return (FullName ? VociEconomiche.class.getName() : (Glb.ClassWithPackage(VociEconomiche.class) ? VociEconomiche.class.getName().substring(VociEconomiche.class.getPackage().getName().length() + 1) : VociEconomiche.class.getName()));
  }
  ...
  private void PAN_VOCIECONOMIC_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("VociEconomiche", "VociEconomicheOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("VociEconomiche", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_VOCIECONOMIC_Init()
  {
    ...
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIECONOMIC_CODICE, "DE5986A1-9F5E-4ABE-928B-CF7837D25E1D");
    ...
    PAN_VOCIECONOMIC.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VOCIECONOMIC_DESCRIZIONE, "4CEDB072-F395-49FA-AEEC-583C54AAA236");
  ...
  private void PAN_VOCIECONOMIC_InitFields()
  {
    ...
    PAN_VOCIECONOMIC.SetFieldPanel(PFL_VOCIECONOMIC_CODICE, PPQRY_VOCIECONOMIC, "A.CODICE", "CODICE", 1, 2, 0, -13997);
    ...
    PAN_VOCIECONOMIC.SetFieldPanel(PFL_VOCIECONOMIC_DESCRIZIONE, PPQRY_VOCIECONOMIC, "DECODE(A.DESCRIZIONE, '', '', A.DESCRIZIONE)", "RECORDDESCRI", 5, 99, 0, -13997);
  }
  ...
  private void PAN_VOCIECONOMIC_InitQueries()
  {
    ...
    PAN_VOCIECONOMIC.SetIMDB(IMDB, "PQRY_VOCIECONOMIC", true);
    ...
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  VOCI_ECONOMICHE A ");
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.E_S = 'S') ");
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_VOCIECONOMIC.SetQuery(PPQRY_VOCIECONOMIC, 5, SQL, -1, "");
    PAN_VOCIECONOMIC.SetQueryDB(PPQRY_VOCIECONOMIC, MainFrm.Cf4armDBObject.DB, 4);
