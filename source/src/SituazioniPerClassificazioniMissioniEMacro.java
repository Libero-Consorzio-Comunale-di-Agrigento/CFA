// **********************************************
// Situazioni Per Classificazioni Missioni E Macro
// Project : Cfa
// **********************************************
...
public final class SituazioniPerClassificazioniMissioniEMacro extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_PERSIT_MACROAGGREGA = 3;
  private static int PFL_PERSIT_DETTAGCAPITO = 4;
  private static int PFL_PERSIT_DESCRIABBREV = 5;
  private static int PFL_PERSIT_SOLOCOMPETEN = 6;
  private static int PFL_PERSIT_DATAELABORAZ = 7;
  private static int PFL_PERSIT_ETICHEELABOR = 8;

  private static int PPQRY_PERSIT2 = 0;
  ...
  {
    Init_TBL_PERSIT9(IMDB);
    //
    //
    Init_PQRY_PERSIT2(IMDB);
    Init_PQRY_PERSIT2_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PERSIT9(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef4.TBL_PERSIT9, 8);
    IMDB.set_TblCode(IMDBDef4.TBL_PERSIT9, "TBL_PERSIT9");
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEMISS, "NOMEOGGEMISS");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEMISS,5,2,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEPROG, "NOMEOGGEPROG");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEPROG,5,4,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGETITO, "NOMEOGGETITO");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGETITO,1,1,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP, "NOMOGGDETCAP");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP,5,2,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM, "NOMOGGSOLCOM");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM,5,2,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDESABB, "NOMOGGDESABB");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDESABB,5,2,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMOGGDATELA,6,14,0);
    IMDB.set_FldCode(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEMACR, "NOMEOGGEMACR");
    IMDB.SetFldParams(IMDBDef4.TBL_PERSIT9,IMDBDef4.FLD_PERSIT9_NOMEOGGEMACR,1,10,0);
    IMDB.TblAddNew(IMDBDef4.TBL_PERSIT9, 0);
  }

  private static void Init_PQRY_PERSIT2(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef13.PQRY_PERSIT2, 8);
    IMDB.set_TblCode(IMDBDef13.PQRY_PERSIT2, "PQRY_PERSIT2");
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMISS, "NOMEOGGEMISS");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMISS,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG, "NOMEOGGEPROG");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG,5,4,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGETITO, "NOMEOGGETITO");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGETITO,1,1,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP, "NOMOGGDETCAP");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM, "NOMOGGSOLCOM");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB, "NOMOGGDESABB");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA,6,14,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMACR, "NOMEOGGEMACR");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMACR,1,10,0);
    IMDB.TblAddNew(IMDBDef13.PQRY_PERSIT2, 0);
  }

  private static void Init_PQRY_PERSIT2_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef13.PQRY_PERSIT2_RS, 8);
    IMDB.set_TblCode(IMDBDef13.PQRY_PERSIT2_RS, "PQRY_PERSIT2_RS");
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMISS, "NOMEOGGEMISS");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMISS,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG, "NOMEOGGEPROG");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG,5,4,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGETITO, "NOMEOGGETITO");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGETITO,1,1,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP, "NOMOGGDETCAP");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM, "NOMOGGSOLCOM");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB, "NOMOGGDESABB");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB,5,2,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA,6,14,0);
    IMDB.set_FldCode(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMACR, "NOMEOGGEMACR");
    IMDB.SetFldParams(IMDBDef13.PQRY_PERSIT2_RS,IMDBDef13.PQSL_PERSIT2_NOMEOGGEMACR,1,10,0);
  }
  ...
  // **********************************************
  public SituazioniPerClassificazioniMissioniEMacro(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SituazioniPerClassificazioniMissioniEMacro()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SITPECLMIEMA;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "019BA8FF-AFDA-4FD7-9F54-D02946495A89";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 532;
    DesignHeight = 226;
    set_Caption(new IDVariant("per Missione, Programma, Macroaggregato"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "FFAF772F-5AE4-4617-B38E-001C6DF77ECB");
    PAN_PERSIT.SetRect(MyGlb.OBJ_PANEL, 0, 0, 0, 0, 576, 156, MyGlb.RESMODE_STRETCH, MyGlb.RESMODE_STRETCH);
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef4.TBL_PERSIT9, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        SITPECLMIEMA_PERSIT2();
      }
  ...
  {
    return (obj instanceof SituazioniPerClassificazioniMissioniEMacro);
  }
  ...
  {
    return (FullName ? SituazioniPerClassificazioniMissioniEMacro.class.getName() : (Glb.ClassWithPackage(SituazioniPerClassificazioniMissioniEMacro.class) ? SituazioniPerClassificazioniMissioniEMacro.class.getName().substring(SituazioniPerClassificazioniMissioniEMacro.class.getPackage().getName().length() + 1) : SituazioniPerClassificazioniMissioniEMacro.class.getName()));
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      // 
      LOAD_PERSITDELETE();
      IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP, 0, (new IDVariant("SI")));
      IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM, 0, (new IDVariant("SI")));
      IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDESABB, 0, (new IDVariant()));
      IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDATELA, 0, IDL.Today());
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SituazioniPerClassificazioniMissioniEMacro", "Load", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEMISS, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEPROG, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGETITO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDESABB, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDATELA, 0, new IDVariant());
    IMDB.set_Value(IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEMACR, 0, new IDVariant());
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SituazioniPerClassificazioniMissioniEMacro", "Unload", _e);
    }
  }
  ...
  private void PAN_PERSIT_OnUpdatingRow(IDVariant Column, IDVariant FieldModified, IDVariant FieldWasModified, IDVariant RowWasModified, IDVariant Inserting, IDVariant Cancel)
  {
    ...
    try
    {
      ...
      {
        IMDB.set_Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG, 0, (new IDVariant()));
      }
      if (Column.equals((new IDVariant(PFL_PERSIT_DETTAGCAPITO)), true) && FieldWasModified.booleanValue())
      {
        if (IDL.NullValue(IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP, 0),(new IDVariant("NO"))).equals((new IDVariant("NO")), true))
        {
          IMDB.set_Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB, 0, (new IDVariant()));
        }
      }
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("SituazioniPerClassificazioniMissioniEMacro", "PerSitOnUpdatingRow", _e);
    }
  }
  ...
  private void PAN_PERSIT_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SituazioniPerClassificazioniMissioniEMacro", "PerSitOnDynamicProperties", _e);
    }
  }
  ...
  public int EtichettaElabora ()
  {
    ...
    try
    {
      ...
      MainFrm.Cf4armDBObject.WORKSITCLASMISPROGMACRO(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMEOGGEMISS, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMEOGGEPROG, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMEOGGETITO, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMEOGGEMACR, 0), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB, 0), ((IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP, 0).equals((new IDVariant("SI")), true))?(new IDVariant()):(new IDVariant("SI"))));
      ...
      else
      {
        ...
        S = (new IDVariant("Sit_Class_MissProgMacro"));
        MainFrm.SetParametroStampaJasper((new IDVariant("P_PROGR_SESSIONE")), IDL.ToString(MainFrm.PROGRESESSIO));
        MainFrm.SetParametroStampaJasper((new IDVariant("P_DETT_CAPITOLI")), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDETCAP, 0));
        MainFrm.SetParametroStampaJasper((new IDVariant("P_DESC_ABB")), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDESABB, 0));
        MainFrm.SetParametroStampaJasper((new IDVariant("P_SOLO_COMP")), IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGSOLCOM, 0));
        MainFrm.SetParametroStampaJasper((new IDVariant("P_DATA_ELAB")), IDL.ToString(IMDB.Value(IMDBDef13.PQRY_PERSIT2, IMDBDef13.PQSL_PERSIT2_NOMOGGDATELA, 0)));
    ...
    {
      MainFrm.ErrObj.ProcError ("SituazioniPerClassificazioniMissioniEMacro", "EtichettaElabora", _e);
      return -1;
    }
  }
  ...
  // **********************************************************************
  private void SITPECLMIEMA_PERSIT2() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef13.PQRY_PERSIT2_RS);
    IMDB.TblMoveFirst(IMDBDef4.TBL_PERSIT9, 0);
    Loop1: while (!IMDB.Eof(IMDBDef4.TBL_PERSIT9, 0))
    {
      IMDB.TblAddNew(IMDBDef13.PQRY_PERSIT2_RS, 0);
      IMDB.TblLinkRow(IMDBDef13.PQRY_PERSIT2_RS, 0, IMDBDef4.TBL_PERSIT9, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 0, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEMISS, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 1, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEPROG, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 2, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGETITO, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 3, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 4, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 5, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDESABB, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 6, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMOGGDATELA, 0);
      IMDB.TblLinkField(IMDBDef13.PQRY_PERSIT2_RS, 7, 0, IMDBDef4.TBL_PERSIT9, IMDBDef4.FLD_PERSIT9_NOMEOGGEMACR, 0);
      IMDB.TblMoveNext(IMDBDef4.TBL_PERSIT9, 0);
      if (IMDB.Eof(IMDBDef4.TBL_PERSIT9, 0))
      {
        IMDB.TblMoveFirst(IMDBDef4.TBL_PERSIT9, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef13.PQRY_PERSIT2_RS, 0);
  }
  ...
  private void PAN_PERSIT_Init()
  {
    ...
    PAN_PERSIT.SetSize(MyGlb.OBJ_FIELD, 9);
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_MISSIONI, "F154B865-F292-4418-A0FD-06BF67D12474");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_PROGRAMMI, "505800C0-04C0-4671-917B-DA2AFF98DFFA");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_TITOLI, "243F109B-B199-454C-899D-CD1C60BE5217");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, "FDB3FF22-35E0-4B4C-AE34-D70EE307CEC9");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_DETTAGCAPITO, "ECFAF1F7-7F5B-46D6-913C-A4B694176AF6");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_DESCRIABBREV, "48B47CE0-E12A-4727-9960-145695FC9991");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_SOLOCOMPETEN, "0AE6F686-A5B8-4E75-BDDF-EB207E8BA5F6");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_DATAELABORAZ, "05BDF763-FBF6-4A23-A329-664597CF754D");
    ...
    PAN_PERSIT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PERSIT_ETICHEELABOR, "62711365-BD3F-4A2D-B2CB-E2DB65945557");
  ...
  private void PAN_PERSIT_InitFields()
  {
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_MISSIONI, PPQRY_PERSIT2, "A.NOMEOGGEMISS", "NOMEOGGEMISS", 5, 2, 0, -13997);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_PROGRAMMI, PPQRY_PERSIT2, "A.NOMEOGGEPROG", "NOMEOGGEPROG", 5, 4, 0, -13997);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_TITOLI, PPQRY_PERSIT2, "A.NOMEOGGETITO", "NOMEOGGETITO", 1, 1, 0, -13997);
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_LIST, 0, 36, 104, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PERSIT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_LIST, 104);
    PAN_PERSIT.SetNumRow(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_LIST, 1);
    PAN_PERSIT.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_LIST, "Macroaggregato");
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_FORM, 20, 76, 464, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PERSIT.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PERSIT_MACROAGGREGA, MyGlb.PANEL_FORM, 104);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_MACROAGGREGA, PPQRY_PERSIT2, "A.NOMEOGGEMACR", "NOMEOGGEMACR", 1, 10, 0, -13997);
    ...
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_DETTAGCAPITO, MyGlb.PANEL_FORM, 12, 100, 136, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_DETTAGCAPITO, PPQRY_PERSIT2, "A.NOMOGGDETCAP", "NOMOGGDETCAP", 5, 2, 0, -13997);
    ...
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_DESCRIABBREV, MyGlb.PANEL_FORM, 156, 100, 176, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_DESCRIABBREV, PPQRY_PERSIT2, "A.NOMOGGDESABB", "NOMOGGDESABB", 5, 2, 0, -13997);
    ...
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_SOLOCOMPETEN, MyGlb.PANEL_FORM, 348, 100, 136, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_SOLOCOMPETEN, PPQRY_PERSIT2, "A.NOMOGGSOLCOM", "NOMOGGSOLCOM", 5, 2, 0, -13997);
    ...
    PAN_PERSIT.SetRect(MyGlb.OBJ_FIELD, PFL_PERSIT_DATAELABORAZ, MyGlb.PANEL_FORM, 8, 124, 200, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PERSIT.SetFieldPanel(PFL_PERSIT_DATAELABORAZ, PPQRY_PERSIT2, "A.NOMOGGDATELA", "NOMOGGDATELA", 6, 14, 0, -13997);
  ...
  private void PAN_PERSIT_InitQueries()
  {
    ...
    PAN_PERSIT.SetSize(MyGlb.OBJ_QUERY, 5);
    ...
    SQL.append("  TO_CHAR ( A.COD_LIV_2 ) || ' - ' || A.DES_LIV_2 as NUOVAESPRESS ");
    SQL.append("from ");
    ...
    SQL.append("  TO_CHAR ( A.COD_LIV_2 ) || ' - ' || A.DES_LIV_2 ");
    SQL.append("order by ");
    SQL.append("  A.COD_LIV_2 ");
    PAN_PERSIT.SetQuery(PPQRY_CF4ESPPIACON, 0, SQL, PFL_PERSIT_MACROAGGREGA, "");
    SQL = new StringBuffer();
    SQL.append("select distinct ");
    SQL.append("  A.COD_LIV_2 as CFESPICOCOL2, ");
    SQL.append("  SUM(1) as NUOVAESPRES1, ");
    ...
    SQL.append("order by ");
    SQL.append("  A.COD_LIV_2 ");
    PAN_PERSIT.SetQuery(PPQRY_CF4ESPPIACON, 1, SQL, PFL_PERSIT_MACROAGGREGA, "");
    PAN_PERSIT.SetQueryDB(PPQRY_CF4ESPPIACON, MainFrm.Cf4armDBObject.DB, 4);
    PAN_PERSIT.SetIMDB(IMDB, "PQRY_PERSIT2", true);
    PAN_PERSIT.set_SetString(MyGlb.MASTER_ROWNAME, "Nome Oggetto");
    PAN_PERSIT.SetQueryIMDB(PPQRY_PERSIT2, IMDBDef13.PQRY_PERSIT2_RS, IMDBDef4.TBL_PERSIT9);
    JustLoaded = true;
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_MISSIONI, IMDBDef4.FLD_PERSIT9_NOMEOGGEMISS);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_PROGRAMMI, IMDBDef4.FLD_PERSIT9_NOMEOGGEPROG);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_TITOLI, IMDBDef4.FLD_PERSIT9_NOMEOGGETITO);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_MACROAGGREGA, IMDBDef4.FLD_PERSIT9_NOMEOGGEMACR);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_DETTAGCAPITO, IMDBDef4.FLD_PERSIT9_NOMOGGDETCAP);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_DESCRIABBREV, IMDBDef4.FLD_PERSIT9_NOMOGGDESABB);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_SOLOCOMPETEN, IMDBDef4.FLD_PERSIT9_NOMOGGSOLCOM);
    PAN_PERSIT.SetFieldPrimaryIndex(PFL_PERSIT_DATAELABORAZ, IMDBDef4.FLD_PERSIT9_NOMOGGDATELA);
    PAN_PERSIT.SetMasterTable(0, "PERSIT9");
    //
