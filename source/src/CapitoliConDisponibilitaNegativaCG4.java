// **********************************************
// Capitoli Con Disponibilita Negativa CG4
// Project : Cfa
// **********************************************
...
public final class CapitoliConDisponibilitaNegativaCG4 extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_MOVIMCASSGC7 = 0;
  ...
  {
    Init_TBL_PARS49(IMDB);
    //
    //
    Init_PQRY_MOVIMCASSGC7(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS49(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef5.TBL_PARS49, 4);
    IMDB.set_TblCode(IMDBDef5.TBL_PARS49, "TBL_PARS49");
    IMDB.set_FldCode(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGCADINE, "NOMOGGCADINE");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGCADINE,1,12,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMEOGGEVPRO, "NOMEOGGEVPRO");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMEOGGEVPRO,5,2,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGNUDIRR, "NOMOGGNUDIRR");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGNUDIRR,1,6,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGANNDIS, "NOMOGGANNDIS");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS49,IMDBDef5.FLD_PARS49_NOMOGGANNDIS,1,4,0);
    IMDB.TblAddNew(IMDBDef5.TBL_PARS49, 0);
  }

  private static void Init_PQRY_MOVIMCASSGC7(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef14.PQRY_MOVIMCASSGC7, 5);
    IMDB.set_TblCode(IMDBDef14.PQRY_MOVIMCASSGC7, "PQRY_MOVIMCASSGC7");
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_RECORBILCAPI, "RECORBILCAPI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_RECORBILCAPI,3,16,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_RECORBILARTI, "RECORBILARTI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_RECORBILARTI,1,2,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_TOTALEIMPORT, "TOTALEIMPORT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_TOTALEIMPORT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_DISPONIBILIT, "DISPONIBILIT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_DISPONIBILIT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_VARPROVVISOR, "VARPROVVISOR");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC7,IMDBDef14.PQSL_MOVIMCASSGC7_VARPROVVISOR,3,28,6);
    IMDB.TblAddNew(IMDBDef14.PQRY_MOVIMCASSGC7, 0);
  }
  ...
  // **********************************************
  public CapitoliConDisponibilitaNegativaCG4(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public CapitoliConDisponibilitaNegativaCG4()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_CAPCONDINECG;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "C4843656-815C-42F9-880F-5841AFBC0D65";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 792;
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "8A5A8B80-5516-4E6C-B3BF-80C42285F39F");
  ...
  {
    return (obj instanceof CapitoliConDisponibilitaNegativaCG4);
  }
  ...
  {
    return (FullName ? CapitoliConDisponibilitaNegativaCG4.class.getName() : (Glb.ClassWithPackage(CapitoliConDisponibilitaNegativaCG4.class) ? CapitoliConDisponibilitaNegativaCG4.class.getName().substring(CapitoliConDisponibilitaNegativaCG4.class.getPackage().getName().length() + 1) : CapitoliConDisponibilitaNegativaCG4.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      // IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMOGGCADINE, 0, new IDVariant(I));
      // IDVariant v_COMMIT = new IDVariant(0,IDVariant.INTEGER);
      // if (IMDB.Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMOGGCADINE, 0).equals((new IDVariant(0)), true))
      // {
    ...
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaCG4", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMOGGCADINE, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMEOGGEVPRO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMOGGNUDIRR, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMOGGANNDIS, 0, new IDVariant());
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      QV.Close();
      IMDB.set_Value(IMDBDef5.TBL_PARS49, IMDBDef5.FLD_PARS49_NOMEOGGEVPRO, 0, ((!(IDL.IsNull(v_VT99COCAVPLI)))?(new IDVariant("SI")):(new IDVariant("NO"))));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaCG4", "Load", _e);
    }
  }
  ...
  private void PAN_CAPITOLI_Init()
  {
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_CAPITOLO, "F7B53B87-D951-46F8-A3AF-6EAA0EB3CC0C");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_ARTICOLO, "3143F295-C207-433F-8286-F7A9F81A4E30");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_TOTALEIMPORT, "7EFAB6EC-8581-4B8D-9D21-D4D6D9527EBA");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DISPONIBILIT, "B15591E6-0DDE-4712-847D-9072C549000B");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_VARPROVVISOR, "6258FC8D-1F8C-4E63-B961-2F588F66E113");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DUALDISPRISU, "170C467F-3A63-45E7-AFCD-D382A92AA21F");
  ...
  private void PAN_CAPITOLI_InitFields()
  {
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_CAPITOLO, PPQRY_MOVIMCASSGC7, "D.CAPITOLO", "RECORBILCAPI", 3, 16, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_ARTICOLO, PPQRY_MOVIMCASSGC7, "D.ARTICOLO", "RECORBILARTI", 1, 2, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_TOTALEIMPORT, PPQRY_MOVIMCASSGC7, "SUM(C.IMPORTO)", "TOTALEIMPORT", 3, 28, 6, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_DISPONIBILIT, PPQRY_MOVIMCASSGC7, "MAX(D.DISPONIBILITA_CA)", "DISPONIBILIT", 3, 28, 6, -13997);
  ...
  SQL.append("))");
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_VARPROVVISOR, PPQRY_MOVIMCASSGC7, SQL.toString(), "VARPROVVISOR", 3, 28, 6, -13997);
  ...
  private void PAN_CAPITOLI_InitQueries()
  {
    ...
    PAN_CAPITOLI.SetIMDB(IMDB, "PQRY_MOVIMCASSGC7", true);
    PAN_CAPITOLI.set_SetString(MyGlb.MASTER_ROWNAME, "Record");
    SQL = new StringBuffer();
    SQL.append("select ");
    SQL.append("  D.CAPITOLO as RECORBILCAPI, ");
    SQL.append("  D.ARTICOLO as RECORBILARTI, ");
    SQL.append("  SUM(C.IMPORTO) as TOTALEIMPORT, ");
    SQL.append("  MAX(D.DISPONIBILITA_CA) as DISPONIBILIT, ");
    SQL.append("  MAX(( ");
    SQL.append("select ");
    SQL.append("  NVL(SUM(NVL(A.IMPORTO_CASSA, 0)), 0) ");
    SQL.append("from ");
    ...
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  MOVIMENTI_CASSE_GC4 B, ");
    SQL.append("  LIQ C, ");
    SQL.append("  BIL D ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (B.ANNO_DISTINTA_RR = ~~TBL_PARS49.NOMOGGANNDIS~~) ");
    SQL.append("and   (B.NUMERO_DISTINTA_RR = ~~TBL_PARS49.NOMOGGNUDIRR~~) ");
    SQL.append("and   (C.ANNO_LIQ = B.ANNO_LIQ) ");
    SQL.append("and   (C.NUMERO_LIQ = B.NUMERO_LIQ) ");
    SQL.append("and   (D.ESERCIZIO = ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (C.ANNO_LIQ = D.ESERCIZIO) ");
    SQL.append("and   (D.E_S = 'S') ");
    SQL.append("and   (D.CAPITOLO = C.CAPITOLO) ");
    SQL.append("and   (D.ARTICOLO = C.ARTICOLO) ");
    SQL.append("and   (CONTROLLO_DISP_CASSA_VPRO_CAP(D.ESERCIZIO,D.CAPITOLO,D.ARTICOLO,CASE WHEN ~~TBL_PARS49.NOMEOGGEVPRO~~ = 'SI' THEN 'LI' ELSE 'EM' END) < 0) ");
    SQL.append("and   (~~TBL_PARS49.NOMEOGGEVPRO~~ = 'SI' OR (~~TBL_PARS49.NOMEOGGEVPRO~~ = 'NO' AND NOT ((C.ANNO_MAND IS NULL)))) ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 2, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("group by ");
    SQL.append("  D.CAPITOLO, ");
    SQL.append("  D.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  D.CAPITOLO, ");
    SQL.append("  D.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC7, 5, SQL, -1, "");
    PAN_CAPITOLI.SetQueryDB(PPQRY_MOVIMCASSGC7, MainFrm.Cf4armDBObject.DB, 4);
    PAN_CAPITOLI.SetMasterTable(0, "MOVIMENTI_CASSE_GC4");
