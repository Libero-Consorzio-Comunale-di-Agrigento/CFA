...
public final class SceltaProgettoIndice2 extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_STANZIPROGE1 = 0;
  ...
  {
    Init_TBL_PARAMETRI234(IMDB);
    //
    //
    Init_PQRY_STANZIPROGE1(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI234(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI234, 4);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI234, "TBL_PARAMETRI234");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMCAPITOL, "PARAMCAPITOL");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMCAPITOL,3,16,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMARTICOL, "PARAMARTICOL");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMARTICOL,1,10,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMES, "PARAMES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMES,5,2,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMDATAREG, "PARAMDATAREG");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI234,IMDBDef1.FLD_PARAMETRI234_PARAMDATAREG,6,49,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI234, 0);
  }

  private static void Init_PQRY_STANZIPROGE1(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_STANZIPROGE1, 3);
    IMDB.set_TblCode(IMDBDef7.PQRY_STANZIPROGE1, "PQRY_STANZIPROGE1");
    IMDB.set_FldCode(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_PROGETTO_ID, "PROGETTO_ID");
    IMDB.SetFldParams(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_PROGETTO_ID,5,9,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_RECORDDESCRI, "RECORDDESCRI");
    IMDB.SetFldParams(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_RECORDDESCRI,5,99,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_RECORDORDINA, "RECORDORDINA");
    IMDB.SetFldParams(IMDBDef7.PQRY_STANZIPROGE1,IMDBDef7.PQSL_STANZIPROGE1_RECORDORDINA,6,0,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_STANZIPROGE1, 0);
  }
  ...
  // **********************************************
  public SceltaProgettoIndice2(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELPROGINDI;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "C7F85ADB-20B8-4381-8AF0-ECF89D700A08";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 552;
    DesignHeight = 374;
    set_Caption(new IDVariant("Scelta Progetto Indice2"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PROGETTI.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 552-MyGlb.PAN_OFFS_X, 348-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "4884284B-B10D-48D7-A23F-512AA7259FA7");
  ...
  {
    return (obj instanceof SceltaProgettoIndice2);
  }
  ...
  {
    return (FullName ? SceltaProgettoIndice2.class.getName() : (Glb.ClassWithPackage(SceltaProgettoIndice2.class) ? SceltaProgettoIndice2.class.getName().substring(SceltaProgettoIndice2.class.getPackage().getName().length() + 1) : SceltaProgettoIndice2.class.getName()));
  }
  ...
  private void PAN_PROGETTI_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaProgettoIndice2", "ProgettiOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaProgettoIndice2", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_PROGETTI_Init()
  {
    ...
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PROGETTI_PROGETTOID, "D8FC4444-A1A2-43E7-8277-3CE265F267E3");
    ...
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PROGETTI_DESCRIZIONE, "29EA341A-1965-467A-8EDE-D1BA13C005EE");
    ...
    PAN_PROGETTI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PROGETTI_ORDINAMENTO, "FC20CD28-9023-44B9-8A6A-828F2DCD563F");
  ...
  private void PAN_PROGETTI_InitFields()
  {
    ...
    PAN_PROGETTI.SetFieldPanel(PFL_PROGETTI_PROGETTOID, PPQRY_STANZIPROGE1, "C.PROGETTO_ID", "PROGETTO_ID", 5, 9, 0, -13997);
    ...
    PAN_PROGETTI.SetFieldPanel(PFL_PROGETTI_DESCRIZIONE, PPQRY_STANZIPROGE1, "MAX(C.PROGRAMMA || ' ' || ' - ' || ' ' || C.CODICE || ' ' || ' - ' || ' ' || C.DESCRIZIONE)", "RECORDDESCRI", 5, 99, 0, -13997);
    ...
    PAN_PROGETTI.SetFieldPanel(PFL_PROGETTI_ORDINAMENTO, PPQRY_STANZIPROGE1, "MAX(DECODE(" + IDL.CSql(MainFrm.ORDINAPROGET, IDL.FMT_CHAR, MainFrm.Cf4armDBObject.DBO()) + ", NULL, TO_DATE('1900-01-01','YYYY-MM-DD'), NVL(C.DATA_INIZIO, TO_DATE('1900-01-01','YYYY-MM-DD'))))", "RECORDORDINA", 6, 0, 0, -13997);
  }
  ...
  private void PAN_PROGETTI_InitQueries()
  {
    ...
    PAN_PROGETTI.SetIMDB(IMDB, "PQRY_STANZIPROGE1", true);
    PAN_PROGETTI.set_SetString(MyGlb.MASTER_ROWNAME, "Record");
    SQL = new StringBuffer();
    SQL.append("select ");
    SQL.append("  C.PROGETTO_ID as PROGETTO_ID, ");
    SQL.append("  MAX(C.PROGRAMMA || ' ' || ' - ' || ' ' || C.CODICE || ' ' || ' - ' || ' ' || C.DESCRIZIONE) as RECORDDESCRI, ");
    SQL.append("  MAX(DECODE(" + IDL.CSql(MainFrm.ORDINAPROGET, IDL.FMT_CHAR, MainFrm.Cf4armDBObject.DBO()) + ", NULL, TO_DATE('1900-01-01','YYYY-MM-DD'), NVL(C.DATA_INIZIO, TO_DATE('1900-01-01','YYYY-MM-DD')))) as RECORDORDINA ");
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  STANZIAMENTI_PROGETTO A, ");
    SQL.append("  STANZIAMENTI_PROG_DETTAGLIO B, ");
    SQL.append("  PROGETTI C ");
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.CAPITOLO = ~~TBL_PARAMETRI234.PARAMCAPITOL~~) ");
    SQL.append("and   (A.ARTICOLO = ~~TBL_PARAMETRI234.PARAMARTICOL~~) ");
    SQL.append("and   (A.E_S = ~~TBL_PARAMETRI234.PARAMES~~) ");
    SQL.append("and   (A.PROGRESSIVO = B.PROGR_STANZIAMENTO) ");
    SQL.append("and   (B.ESERCIZIO = ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (A.ESERCIZIO_RIF = ~~TBL_DATISESSIONE.SESSIOESERCI~~) ");
    SQL.append("and   (C.PROGETTO_ID = A.PROGETTO_ID) ");
    SQL.append("and   (((C.DATA_FINE_EFFETTIVA IS NULL) OR C.DATA_FINE_EFFETTIVA > ~~TBL_PARAMETRI234.PARAMDATAREG~~)) ");
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 2, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("group by ");
    SQL.append("  C.PROGETTO_ID ");
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by 3, 1 ");
    PAN_PROGETTI.SetQuery(PPQRY_STANZIPROGE1, 5, SQL, -1, "");
    PAN_PROGETTI.SetQueryDB(PPQRY_STANZIPROGE1, MainFrm.Cf4armDBObject.DB, 4);
    PAN_PROGETTI.SetMasterTable(0, "STANZIAMENTI_PROGETTO");
