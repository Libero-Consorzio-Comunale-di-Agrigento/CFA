...
public final class PEGConsuntivo extends MyWebForm implements Serializable
{  
  ...
  private static int PFL_PARAM_DETTAGLIO = 5;

  private static int PPQRY_PARAM138 = 0;
  ...
  {
    Init_TBL_PARAM102(IMDB);
    //
    //
    Init_PQRY_PARAM138(IMDB);
    Init_PQRY_PARAM138_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAM102(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.TBL_PARAM102, 4);
    IMDB.set_TblCode(IMDBDef7.TBL_PARAM102, "TBL_PARAM102");
    IMDB.set_FldCode(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMEOGGEPART, "NOMEOGGEPART");
    IMDB.SetFldParams(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMEOGGEPART,5,1,0);
    IMDB.set_FldCode(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMOGGMAGMIN, "NOMOGGMAGMIN");
    IMDB.SetFldParams(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMOGGMAGMIN,5,2,0);
    IMDB.set_FldCode(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMOGGDATELA,6,52,0);
    IMDB.set_FldCode(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMEOGGEDETT, "NOMEOGGEDETT");
    IMDB.SetFldParams(IMDBDef7.TBL_PARAM102,IMDBDef7.FLD_PARAM102_NOMEOGGEDETT,5,2,0);
    IMDB.TblAddNew(IMDBDef7.TBL_PARAM102, 0);
  }

  private static void Init_PQRY_PARAM138(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef17.PQRY_PARAM138, 4);
    IMDB.set_TblCode(IMDBDef17.PQRY_PARAM138, "PQRY_PARAM138");
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMEOGGEPART, "NOMEOGGEPART");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMEOGGEPART,5,1,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN, "NOMOGGMAGMIN");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN,5,2,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMOGGDATELA,6,52,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMEOGGEDETT, "NOMEOGGEDETT");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138,IMDBDef17.PQSL_PARAM138_NOMEOGGEDETT,5,2,0);
    IMDB.TblAddNew(IMDBDef17.PQRY_PARAM138, 0);
  }

  private static void Init_PQRY_PARAM138_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef17.PQRY_PARAM138_RS, 4);
    IMDB.set_TblCode(IMDBDef17.PQRY_PARAM138_RS, "PQRY_PARAM138_RS");
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMEOGGEPART, "NOMEOGGEPART");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMEOGGEPART,5,1,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN, "NOMOGGMAGMIN");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN,5,2,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMOGGDATELA, "NOMOGGDATELA");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMOGGDATELA,6,52,0);
    IMDB.set_FldCode(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMEOGGEDETT, "NOMEOGGEDETT");
    IMDB.SetFldParams(IMDBDef17.PQRY_PARAM138_RS,IMDBDef17.PQSL_PARAM138_NOMEOGGEDETT,5,2,0);
  }
  ...
  // **********************************************
  public PEGConsuntivo(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_PEGCONSUNTIV;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "8D09D166-F627-414A-A295-614C3AEB0AD1";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 296;
    DesignHeight = 266;
    set_Caption(new IDVariant("P.e.g. Consuntivo"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 296-MyGlb.PAN_OFFS_X, 240-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "21AC8665-AD3C-4DF9-A433-87C54F436CF2");
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef7.TBL_PARAM102, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        PEGCONSUNTIV_PARAM138();
      }
  ...
  {
    return (obj instanceof PEGConsuntivo);
  }
  ...
  {
    return (FullName ? PEGConsuntivo.class.getName() : (Glb.ClassWithPackage(PEGConsuntivo.class) ? PEGConsuntivo.class.getName().substring(PEGConsuntivo.class.getPackage().getName().length() + 1) : PEGConsuntivo.class.getName()));
  }
  ...
  private void PAN_PARAM_DynamicProperties ()
  {
    ...
    try
    {
      ...
      // Corpo Procedura
      // 
      if (IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMEOGGEPART, 0).equals((new IDVariant("E")), true))
      {
    ...
    {
      MainFrm.ErrObj.ProcError ("PEGConsuntivo", "ParamOnDynamicProperties", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      // Corpo Procedura
      // 
      IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEPART, 0, (new IDVariant("E")));
      IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMOGGDATELA, 0, IDL.Today());
      IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEDETT, 0, (new IDVariant("SI")));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("PEGConsuntivo", "Load", _e);
    }
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("PEGConsuntivo", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEPART, 0, new IDVariant());
    IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMOGGMAGMIN, 0, new IDVariant());
    IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMOGGDATELA, 0, new IDVariant());
    IMDB.set_Value(IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEDETT, 0, new IDVariant());
  }
  ...
  public int EtichettaElabora ()
  {
    ...
    try
    {
      ...
      if (IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMEOGGEPART, 0).equals((new IDVariant("E")), true))
      {
        MainFrm.Cf4armDBObject.WORKESTRAZPEGECONSDL77(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN, 0), MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMOGGDATELA, 0));
      }
      else
      {
        MainFrm.Cf4armDBObject.WORKESTRAZPEGSCONSDL77(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN, 0), MainFrm.PROGRESESSIO, IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMOGGDATELA, 0));
      }
      ...
      MainFrm.SetParametroStampaJasper((new IDVariant("DETTAGLI")), IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMEOGGEDETT, 0));
      MainFrm.SetParametroStampaJasper((new IDVariant("SEGNO")), IDL.NullValue(IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMOGGMAGMIN, 0),(new IDVariant("NO"))));
      MainFrm.LanciaStampaJasper(((IMDB.Value(IMDBDef17.PQRY_PARAM138, IMDBDef17.PQSL_PARAM138_NOMEOGGEPART, 0).equals((new IDVariant("E"))))?(new IDVariant("Peg_Consuntivo_e")):(new IDVariant("Peg_Consuntivo_s"))), (new IDVariant("")), (new IDVariant("")), (new IDVariant("")));
      return 0;
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("PEGConsuntivo", "EtichettaElabora", _e);
      return -1;
    }
  }
  ...
  // **********************************************************************
  private void PEGCONSUNTIV_PARAM138() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef17.PQRY_PARAM138_RS);
    IMDB.TblMoveFirst(IMDBDef7.TBL_PARAM102, 0);
    Loop1: while (!IMDB.Eof(IMDBDef7.TBL_PARAM102, 0))
    {
      IMDB.TblAddNew(IMDBDef17.PQRY_PARAM138_RS, 0);
      IMDB.TblLinkRow(IMDBDef17.PQRY_PARAM138_RS, 0, IMDBDef7.TBL_PARAM102, 0);
      IMDB.TblLinkField(IMDBDef17.PQRY_PARAM138_RS, 0, 0, IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEPART, 0);
      IMDB.TblLinkField(IMDBDef17.PQRY_PARAM138_RS, 1, 0, IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMOGGMAGMIN, 0);
      IMDB.TblLinkField(IMDBDef17.PQRY_PARAM138_RS, 2, 0, IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMOGGDATELA, 0);
      IMDB.TblLinkField(IMDBDef17.PQRY_PARAM138_RS, 3, 0, IMDBDef7.TBL_PARAM102, IMDBDef7.FLD_PARAM102_NOMEOGGEDETT, 0);
      IMDB.TblMoveNext(IMDBDef7.TBL_PARAM102, 0);
      if (IMDB.Eof(IMDBDef7.TBL_PARAM102, 0))
      {
        IMDB.TblMoveFirst(IMDBDef7.TBL_PARAM102, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef17.PQRY_PARAM138_RS, 0);
  }
  ...
  private void PAN_PARAM_Init()
  {
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_GROUP, GRP_PARAM_PARTE, "D7D247B5-659A-4571-AD1F-C5FC84F1FE66");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_PARTE, "CF727723-BCCB-45E6-94FF-82FA53BB8E80");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_ETICHETLABEL, "C96BA75B-3AB2-434B-BB2C-F93ECD0A11C2");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_MAGOMIENCOSE, "AE9764CB-DC2F-475B-956F-51DA068BCE2B");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_DATAELABORAZ, "580398C5-5385-4CE5-A570-C3C26B5AD0A3");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_ETICHEELABOR, "8E4FD0AA-D04B-4834-8DB2-1A2A41186A75");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, "C1D4A64D-ECF6-4287-B09D-141C18ABD795");
    ...
    PAN_PARAM.SetFlags(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, 0 | MyGlb.OBJ_ENABLED | MyGlb.OBJ_VISIBLE | MyGlb.FLD_INFORM | MyGlb.FLD_ACTIVE | MyGlb.FLD_ISOPT, -1);
  }
  ...
  private void PAN_PARAM_InitFields()
  {
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_PARTE, PPQRY_PARAM138, "A.NOMEOGGEPART", "NOMEOGGEPART", 5, 1, 0, -13997);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_MAGOMIENCOSE, MyGlb.PANEL_FORM, 20, 108, 236, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_MAGOMIENCOSE, PPQRY_PARAM138, "A.NOMOGGMAGMIN", "NOMOGGMAGMIN", 5, 2, 0, -13997);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_DATAELABORAZ, MyGlb.PANEL_FORM, 52, 132, 204, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_DATAELABORAZ, PPQRY_PARAM138, "A.NOMOGGDATELA", "NOMOGGDATELA", 6, 52, 0, -13997);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_ETICHEELABOR, MyGlb.PANEL_FORM, 176, 172, 80, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_LIST, 0, 36, 60, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAM.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_LIST, 60);
    PAN_PARAM.SetNumRow(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_LIST, 1);
    PAN_PARAM.SetAbbrHeader(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_LIST, "Dettaglio");
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_FORM, 172, 84, 84, 20, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
    PAN_PARAM.SetHeaderSize(MyGlb.OBJ_FIELD, PFL_PARAM_DETTAGLIO, MyGlb.PANEL_FORM, 60);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_DETTAGLIO, PPQRY_PARAM138, "A.NOMEOGGEDETT", "NOMEOGGEDETT", 5, 2, 0, -13997);
    PAN_PARAM.SetValueListItem(PFL_PARAM_DETTAGLIO, (new IDVariant("SI")), "SI", "", "", -1);
  ...
  private void PAN_PARAM_InitQueries()
  {
    ...
    PAN_PARAM.SetIMDB(IMDB, "PQRY_PARAM138", true);
    PAN_PARAM.set_SetString(MyGlb.MASTER_ROWNAME, "Nome Oggetto");
    PAN_PARAM.SetQueryIMDB(PPQRY_PARAM138, IMDBDef17.PQRY_PARAM138_RS, IMDBDef7.TBL_PARAM102);
    JustLoaded = true;
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_PARTE, IMDBDef7.FLD_PARAM102_NOMEOGGEPART);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_MAGOMIENCOSE, IMDBDef7.FLD_PARAM102_NOMOGGMAGMIN);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_DATAELABORAZ, IMDBDef7.FLD_PARAM102_NOMOGGDATELA);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_DETTAGLIO, IMDBDef7.FLD_PARAM102_NOMEOGGEDETT);
    PAN_PARAM.SetMasterTable(0, "PARAM102");
    //
