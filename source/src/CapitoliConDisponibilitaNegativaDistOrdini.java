// **********************************************
// Capitoli Con Disponibilita Negativa Dist Ordini
// Project : Cfa
// **********************************************
...
public final class CapitoliConDisponibilitaNegativaDistOrdini extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_MOVIMCASSGC6 = 0;
  ...
  {
    Init_TBL_PARS37(IMDB);
    //
    //
    Init_PQRY_MOVIMCASSGC6(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS37(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef5.TBL_PARS37, 4);
    IMDB.set_TblCode(IMDBDef5.TBL_PARS37, "TBL_PARS37");
    IMDB.set_FldCode(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGCADINE, "NOMOGGCADINE");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGCADINE,1,12,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMEOGGEVPRO, "NOMEOGGEVPRO");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMEOGGEVPRO,5,2,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGNUMDIS, "NOMOGGNUMDIS");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGNUMDIS,1,6,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGANNDIS, "NOMOGGANNDIS");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS37,IMDBDef5.FLD_PARS37_NOMOGGANNDIS,1,4,0);
    IMDB.TblAddNew(IMDBDef5.TBL_PARS37, 0);
  }

  private static void Init_PQRY_MOVIMCASSGC6(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef14.PQRY_MOVIMCASSGC6, 5);
    IMDB.set_TblCode(IMDBDef14.PQRY_MOVIMCASSGC6, "PQRY_MOVIMCASSGC6");
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_RECORBILCAPI, "RECORBILCAPI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_RECORBILCAPI,3,16,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_RECORBILARTI, "RECORBILARTI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_RECORBILARTI,1,2,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_TOTALEIMPORT, "TOTALEIMPORT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_TOTALEIMPORT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_DISPONIBILIT, "DISPONIBILIT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_DISPONIBILIT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_VARPROVVISOR, "VARPROVVISOR");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC6,IMDBDef14.PQSL_MOVIMCASSGC6_VARPROVVISOR,3,28,6);
    IMDB.TblAddNew(IMDBDef14.PQRY_MOVIMCASSGC6, 0);
  }
  ...
  // **********************************************
  public CapitoliConDisponibilitaNegativaDistOrdini(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public CapitoliConDisponibilitaNegativaDistOrdini()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_CACODINEDIOR;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "89BC1C41-8301-408A-94FC-2666A501C926";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 792;
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "B20375FC-AF3D-47F9-BA65-644D2896CD55");
  ...
  {
    return (obj instanceof CapitoliConDisponibilitaNegativaDistOrdini);
  }
  ...
  {
    return (FullName ? CapitoliConDisponibilitaNegativaDistOrdini.class.getName() : (Glb.ClassWithPackage(CapitoliConDisponibilitaNegativaDistOrdini.class) ? CapitoliConDisponibilitaNegativaDistOrdini.class.getName().substring(CapitoliConDisponibilitaNegativaDistOrdini.class.getPackage().getName().length() + 1) : CapitoliConDisponibilitaNegativaDistOrdini.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      // IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMOGGCADINE, 0, new IDVariant(I));
      // IDVariant v_COMMIT = new IDVariant(0,IDVariant.INTEGER);
      // if (IMDB.Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMOGGCADINE, 0).equals((new IDVariant(0)), true))
      // {
    ...
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaDistOrdini", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMOGGCADINE, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMEOGGEVPRO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMOGGNUMDIS, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMOGGANNDIS, 0, new IDVariant());
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      QV.Close();
      IMDB.set_Value(IMDBDef5.TBL_PARS37, IMDBDef5.FLD_PARS37_NOMEOGGEVPRO, 0, ((!(IDL.IsNull(v_VT99COCAVPLI)))?(new IDVariant("SI")):(new IDVariant("NO"))));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaDistOrdini", "Load", _e);
    }
  }
  ...
  private void PAN_CAPITOLI_Init()
  {
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_CAPITOLO, "F80FB404-1FC5-4131-AF49-9CF0706E0EF5");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_ARTICOLO, "E9D64B36-13C9-42F2-BDBA-A9C710162A55");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_TOTALEIMPORT, "326F1F46-A21F-4D2D-8230-2E07233D4F8C");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DISPONIBILIT, "90C6191C-F6EA-464F-909C-2A6A56ADC20B");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_VARPROVVISOR, "9201F26C-F183-4E8D-9CF0-EC352C3189E9");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DUALDISPRISU, "0C3A7A11-1FC0-4CF0-B8D7-1680F222DE70");
  ...
  private void PAN_CAPITOLI_InitFields()
  {
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_CAPITOLO, PPQRY_MOVIMCASSGC6, "C.CAPITOLO", "RECORBILCAPI", 3, 16, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_ARTICOLO, PPQRY_MOVIMCASSGC6, "C.ARTICOLO", "RECORBILARTI", 1, 2, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_TOTALEIMPORT, PPQRY_MOVIMCASSGC6, "SUM(B.IMPORTO)", "TOTALEIMPORT", 3, 28, 6, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_DISPONIBILIT, PPQRY_MOVIMCASSGC6, "MAX(C.DISPONIBILITA_CA)", "DISPONIBILIT", 3, 28, 6, -13997);
  ...
  SQL.append("))");
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_VARPROVVISOR, PPQRY_MOVIMCASSGC6, SQL.toString(), "VARPROVVISOR", 3, 28, 6, -13997);
  ...
  private void PAN_CAPITOLI_InitQueries()
  {
    ...
    PAN_CAPITOLI.SetIMDB(IMDB, "PQRY_MOVIMCASSGC6", true);
    ...
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  WRK_LIQ_DISTINTA B, ");
    SQL.append("  BIL C ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (B.ANNO_DISTINTA = ~~TBL_PARS37.NOMOGGANNDIS~~) ");
    SQL.append("and   (B.NUMERO_DISTINTA = ~~TBL_PARS37.NOMOGGNUMDIS~~) ");
    ...
    SQL.append("and   (CONTROLLO_DISP_CASSA_VPRO_CAP(C.ESERCIZIO,C.CAPITOLO,C.ARTICOLO,CASE WHEN ~~TBL_PARS37.NOMEOGGEVPRO~~ = 'SI' THEN 'LI' ELSE 'EM' END) < 0) ");
    SQL.append("and   (~~TBL_PARS37.NOMEOGGEVPRO~~ = 'SI' OR (~~TBL_PARS37.NOMEOGGEVPRO~~ = 'NO' AND NOT ((B.ANNO_MAND IS NULL)))) ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 2, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("group by ");
    SQL.append("  C.CAPITOLO, ");
    SQL.append("  C.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  C.CAPITOLO, ");
    SQL.append("  C.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC6, 5, SQL, -1, "");
    PAN_CAPITOLI.SetQueryDB(PPQRY_MOVIMCASSGC6, MainFrm.Cf4armDBObject.DB, 4);
    PAN_CAPITOLI.SetMasterTable(0, "WRK_LIQ_DISTINTA");
