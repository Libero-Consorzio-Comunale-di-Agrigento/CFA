...
public final class ContabilizzazioneIVA extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_PARAM147 = 0;
  ...
  {
    Init_TBL_PARAM34(IMDB);
    //
    //
    Init_PQRY_PARAM147(IMDB);
    Init_PQRY_PARAM147_RS(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAM34(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef2.TBL_PARAM34, 4);
    IMDB.set_TblCode(IMDBDef2.TBL_PARAM34, "TBL_PARAM34");
    IMDB.set_FldCode(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMTIPREG, "ROWNAMTIPREG");
    IMDB.SetFldParams(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMTIPREG,1,8,0);
    IMDB.set_FldCode(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL, "ROWNAMTIPBOL");
    IMDB.SetFldParams(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL,1,8,0);
    IMDB.set_FldCode(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMREGBOL, "ROWNAMREGBOL");
    IMDB.SetFldParams(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMREGBOL,5,50,0);
    IMDB.set_FldCode(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMDOCEME, "ROWNAMDOCEME");
    IMDB.SetFldParams(IMDBDef2.TBL_PARAM34,IMDBDef2.FLD_PARAM34_ROWNAMDOCEME,6,15,0);
    IMDB.TblAddNew(IMDBDef2.TBL_PARAM34, 0);
  }

  private static void Init_PQRY_PARAM147(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef9.PQRY_PARAM147, 4);
    IMDB.set_TblCode(IMDBDef9.PQRY_PARAM147, "PQRY_PARAM147");
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMTIPREG, "ROWNAMTIPREG");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMTIPREG,1,8,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMTIPBOL, "ROWNAMTIPBOL");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMTIPBOL,1,8,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL, "ROWNAMREGBOL");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL,5,50,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME, "ROWNAMDOCEME");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147,IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME,6,15,0);
    IMDB.TblAddNew(IMDBDef9.PQRY_PARAM147, 0);
  }

  private static void Init_PQRY_PARAM147_RS(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef9.PQRY_PARAM147_RS, 4);
    IMDB.set_TblCode(IMDBDef9.PQRY_PARAM147_RS, "PQRY_PARAM147_RS");
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMTIPREG, "ROWNAMTIPREG");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMTIPREG,1,8,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMTIPBOL, "ROWNAMTIPBOL");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMTIPBOL,1,8,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL, "ROWNAMREGBOL");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL,5,50,0);
    IMDB.set_FldCode(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME, "ROWNAMDOCEME");
    IMDB.SetFldParams(IMDBDef9.PQRY_PARAM147_RS,IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME,6,15,0);
  }
  ...
  // **********************************************
  public ContabilizzazioneIVA(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_CONTABILIIVA;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "8BA3E6B8-A8F3-4927-88FE-82003D61E6EC";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 396;
    DesignHeight = 198;
    set_Caption(new IDVariant("Contabilizzazione IVA"));
    //
    Frames = new AFrame[2];
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "AADA50AB-96E8-4681-9D25-61B70E8CF54F");
  ...
  public void UpdateControls()
  {
    try
    {    
      if (IMDB.TblModified(IMDBDef2.TBL_PARAM34, MyGlb.GlbRefModIdx) || JustLoaded)
      {
        CONTABILIIVA_PARAM147();
      }
  ...
  {
    return (obj instanceof ContabilizzazioneIVA);
  }
  ...
  {
    return (FullName ? ContabilizzazioneIVA.class.getName() : (Glb.ClassWithPackage(ContabilizzazioneIVA.class) ? ContabilizzazioneIVA.class.getName().substring(ContabilizzazioneIVA.class.getPackage().getName().length() + 1) : ContabilizzazioneIVA.class.getName()));
  }
  ...
  private void PFL_PARAM_TIPOREGIBOLL_ValidateCell(IDVariant Cancel)
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      if (!(IDL.IsNull(IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL, 0))))
      {
        IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPREG, 0, IDL.ToInteger(IDL.SubStr(IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL, 0), (new IDVariant(0)), (new IDVariant(1)))));
        IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL, 0, IDL.ToInteger(IDL.Trim(IDL.SubStr(IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMREGBOL, 0), (new IDVariant(2)), (new IDVariant(2))), true, true)));
      }
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("ContabilizzazioneIVA", "ParamTipoRegistroBollatoValidateEvent", _e);
    }
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPREG, 0, (new IDVariant()));
      IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL, 0, (new IDVariant()));
      IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMREGBOL, 0, (new IDVariant()));
      IMDB.set_Value(IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMDOCEME, 0, (new IDVariant()));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("ContabilizzazioneIVA", "UnloadEvent", _e);
    }
  }
  ...
  public int OK ()
  {
    ...
    try
    {
      ...
      // Procedure Body
      // 
      if (IDL.IsNull(IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME, 0)))
      {
      ...
      MainFrm.Cf4armDBObject.CONTABILIZZAIVADOCCNC(IMDB.Value(IMDBDef7.TBL_DATISESSIONE, IMDBDef7.FLD_DATISESSIONE_SESSIOESERCI, 0), IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMTIPREG, 0), IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMTIPBOL, 0), IMDB.Value(IMDBDef9.PQRY_PARAM147, IMDBDef9.PQSL_PARAM147_ROWNAMDOCEME, 0), v_NUMERODOCUME);
    ...
    {
      MainFrm.ErrObj.ProcError ("ContabilizzazioneIVA", "OK", _e);
      return -1;
    }
  }
  ...
  // **********************************************************************
  private void CONTABILIIVA_PARAM147() throws SQLException
  {
    IDVariant[] AggrBuff;
    int[] AggrRowCount;
    int AggrCount=0;
    ...
    IMDB.TblTruncate(IMDBDef9.PQRY_PARAM147_RS);
    IMDB.TblMoveFirst(IMDBDef2.TBL_PARAM34, 0);
    Loop1: while (!IMDB.Eof(IMDBDef2.TBL_PARAM34, 0))
    {
      IMDB.TblAddNew(IMDBDef9.PQRY_PARAM147_RS, 0);
      IMDB.TblLinkRow(IMDBDef9.PQRY_PARAM147_RS, 0, IMDBDef2.TBL_PARAM34, 0);
      IMDB.TblLinkField(IMDBDef9.PQRY_PARAM147_RS, 0, 0, IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPREG, 0);
      IMDB.TblLinkField(IMDBDef9.PQRY_PARAM147_RS, 1, 0, IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL, 0);
      IMDB.TblLinkField(IMDBDef9.PQRY_PARAM147_RS, 2, 0, IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMREGBOL, 0);
      IMDB.TblLinkField(IMDBDef9.PQRY_PARAM147_RS, 3, 0, IMDBDef2.TBL_PARAM34, IMDBDef2.FLD_PARAM34_ROWNAMDOCEME, 0);
      IMDB.TblMoveNext(IMDBDef2.TBL_PARAM34, 0);
      if (IMDB.Eof(IMDBDef2.TBL_PARAM34, 0))
      {
        IMDB.TblMoveFirst(IMDBDef2.TBL_PARAM34, 0);
      }
      else
    ...
    IMDB.TblMoveFirst(IMDBDef9.PQRY_PARAM147_RS, 0);
  }
  ...
  private void PAN_PARAM_Init()
  {
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_TIPOREGISTRO, "939085FC-FA0C-4D10-8460-39D8CD09B4B2");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_TIPOBOLLATO, "2184FA11-D9FE-4C2E-B691-B07F15424CC8");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_TIPOREGIBOLL, "2492A243-8D32-4E63-BDAE-1679040C5B2A");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_DOCUEMEFINAL, "8B9B5153-7975-47EA-BFCD-7892264748E6");
    ...
    PAN_PARAM.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_PARAM_ELABORA, "2EE1BFAC-6994-4EC0-8973-A1C9E664E247");
  ...
  private void PAN_PARAM_InitFields()
  {
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_TIPOREGISTRO, PPQRY_PARAM147, "A.ROWNAMTIPREG", "ROWNAMTIPREG", 1, 8, 0, -13997);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_TIPOBOLLATO, PPQRY_PARAM147, "A.ROWNAMTIPBOL", "ROWNAMTIPBOL", 1, 8, 0, -13997);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_TIPOREGIBOLL, PPQRY_PARAM147, "A.ROWNAMREGBOL", "ROWNAMREGBOL", 5, 50, 0, -13997);
    ...
    PAN_PARAM.SetFieldPanel(PFL_PARAM_DOCUEMEFINAL, PPQRY_PARAM147, "A.ROWNAMDOCEME", "ROWNAMDOCEME", 6, 15, 0, -13997);
    ...
    PAN_PARAM.SetRect(MyGlb.OBJ_FIELD, PFL_PARAM_ELABORA, MyGlb.PANEL_FORM, 292, 76, 80, 32, MyGlb.RESMODE_NONE, MyGlb.RESMODE_NONE);
  ...
  private void PAN_PARAM_InitQueries()
  {
    ...
    PAN_PARAM.SetIMDB(IMDB, "PQRY_PARAM147", true);
    PAN_PARAM.set_SetString(MyGlb.MASTER_ROWNAME, "Row Name");
    PAN_PARAM.SetQueryIMDB(PPQRY_PARAM147, IMDBDef9.PQRY_PARAM147_RS, IMDBDef2.TBL_PARAM34);
    JustLoaded = true;
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_TIPOREGISTRO, IMDBDef2.FLD_PARAM34_ROWNAMTIPREG);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_TIPOBOLLATO, IMDBDef2.FLD_PARAM34_ROWNAMTIPBOL);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_TIPOREGIBOLL, IMDBDef2.FLD_PARAM34_ROWNAMREGBOL);
    PAN_PARAM.SetFieldPrimaryIndex(PFL_PARAM_DOCUEMEFINAL, IMDBDef2.FLD_PARAM34_ROWNAMDOCEME);
    PAN_PARAM.SetMasterTable(0, "PARAM34");
    //
