...
public final class SceltaFinanziamentiSubimp extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_FINANZIAME23 = 0;
  ...
  {
    Init_TBL_PARAMETRI87(IMDB);
    //
    //
    Init_PQRY_FINANZIAME23(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI87(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI87, 3);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI87, "TBL_PARAMETRI87");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARAANNOIMPE, "PARAANNOIMPE");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARAANNOIMPE,1,10,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARANUMEIMPE, "PARANUMEIMPE");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARANUMEIMPE,1,10,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARAMOPERA, "PARAMOPERA");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI87,IMDBDef1.FLD_PARAMETRI87_PARAMOPERA,1,10,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI87, 0);
  }

  private static void Init_PQRY_FINANZIAME23(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_FINANZIAME23, 9);
    IMDB.set_TblCode(IMDBDef7.PQRY_FINANZIAME23, "PQRY_FINANZIAME23");
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_CODICE, "CODICE");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_CODICE,1,5,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_DESCRIZIONE,5,200,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_FIBERASOESES, "FIBERASOESES");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_FIBERASOESES,5,60,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_ENTE, "ENTE");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_ENTE,1,6,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_NUMERO_MUTUO, "NUMERO_MUTUO");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_NUMERO_MUTUO,5,10,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_ANNO_MUTUO, "ANNO_MUTUO");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_ANNO_MUTUO,1,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_CATEGORIA, "CATEGORIA");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_CATEGORIA,1,3,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_SCADENZA, "SCADENZA");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_SCADENZA,1,4,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_FINANZCATEG1, "FINANZCATEG1");
    IMDB.SetFldParams(IMDBDef7.PQRY_FINANZIAME23,IMDBDef7.PQSL_FINANZIAME23_FINANZCATEG1,5,99,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_FINANZIAME23, 0);
  }
  ...
  // **********************************************
  public SceltaFinanziamentiSubimp(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SceltaFinanziamentiSubimp()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELFINASUBI;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "5399D664-8F9A-462C-BB1E-B3827890F5E3";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 588;
    DesignHeight = 398;
    set_Caption(new IDVariant("Scelta Finanziamenti Subimp"));
    //
    Frames = new AFrame[2];
    ...
    PAN_FINANZIAMENT.SetRect(MyGlb.OBJ_RECT, 0, 0, 0, 0, 588-MyGlb.PAN_OFFS_X, 372-MyGlb.PAN_OFFS_Y, 0, 0);
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "027DD94E-324A-4452-8840-6D81C9CB3FAD");
  ...
  {
    return (obj instanceof SceltaFinanziamentiSubimp);
  }
  ...
  {
    return (FullName ? SceltaFinanziamentiSubimp.class.getName() : (Glb.ClassWithPackage(SceltaFinanziamentiSubimp.class) ? SceltaFinanziamentiSubimp.class.getName().substring(SceltaFinanziamentiSubimp.class.getPackage().getName().length() + 1) : SceltaFinanziamentiSubimp.class.getName()));
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaFinanziamentiSubimp", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_FINANZIAMENT_Init()
  {
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CODICE, "F8F95011-5C30-4DE1-BCA8-5D0FA54E5CB6");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_DESCRIZIONE, "844EB01E-EDE7-4527-8722-0769192E40F0");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE1, "4076B98C-78A8-4D1C-801C-1022BDDDBE44");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ENTE, "4016C820-5F68-45E2-85BD-ADFAF3EAFC6A");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_NUMEROMUTUO, "37F6F5E2-9954-4613-909A-631D3A30444E");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_ANNOMUTUO, "11A52EB2-9476-45A1-A0F9-F24971D7CFA4");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_CATEGORIA, "61A4D073-67CD-4EC8-85DC-0565F15E1859");
    ...
    PAN_FINANZIAMENT.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FINANZIAMENT_SCADENZA, "ABBDBE2B-93B0-49B3-9E92-091D217DE455");
  ...
  private void PAN_FINANZIAMENT_InitFields()
  {
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_CODICE, PPQRY_FINANZIAME23, "A.CODICE", "CODICE", 1, 5, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_DESCRIZIONE, PPQRY_FINANZIAME23, "A.DESCRIZIONE", "DESCRIZIONE", 5, 200, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_ENTE1, PPQRY_FINANZIAME23, "B.RAGIONE_SOCIALE_ESTESA", "FIBERASOESES", 5, 60, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_ENTE, PPQRY_FINANZIAME23, "A.ENTE", "ENTE", 1, 6, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_NUMEROMUTUO, PPQRY_FINANZIAME23, "A.NUMERO_MUTUO", "NUMERO_MUTUO", 5, 10, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_ANNOMUTUO, PPQRY_FINANZIAME23, "A.ANNO_MUTUO", "ANNO_MUTUO", 1, 4, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_CATEGORIA, PPQRY_FINANZIAME23, "DECODE(A.CATEGORIA, to_number(NULL), 'Nulla', TO_CHAR ( A.CATEGORIA ) || ' ' || ' - ' || ' ' || C.DESCRIZIONE)", "FINANZCATEG1", 5, 99, 0, -13997);
    ...
    PAN_FINANZIAMENT.SetFieldPanel(PFL_FINANZIAMENT_SCADENZA, PPQRY_FINANZIAME23, "A.SCADENZA", "SCADENZA", 1, 4, 0, -13997);
  }
  ...
  private void PAN_FINANZIAMENT_InitQueries()
  {
    ...
    PAN_FINANZIAMENT.SetIMDB(IMDB, "PQRY_FINANZIAME23", true);
    ...
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  FINANZIAMENTI A, ");
    SQL.append("  BEN B, ");
    SQL.append("  CATEGORIE_FIN C, ");
    SQL.append("  IMP_FIN D ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.ENTE = B.CODICE(+)) ");
    SQL.append("and   (A.CATEGORIA = C.CODICE(+)) ");
    SQL.append("and   (A.CODICE = D.FINANZIAMENTO) ");
    SQL.append("and   ((A.SCADENZA IS NULL) OR A.SCADENZA >= ~~TBL_PARAMETRI87.PARAANNOIMPE~~) ");
    SQL.append("and   (NVL(D.OPERA, -1) = DECODE(~~TBL_PARAMETRI87.PARAMOPERA~~, -1, NVL(D.OPERA, -1), ~~TBL_PARAMETRI87.PARAMOPERA~~)) ");
    SQL.append("and   (D.ANNO_IMP = ~~TBL_PARAMETRI87.PARAANNOIMPE~~) ");
    SQL.append("and   (D.NUMERO_IMP = ~~TBL_PARAMETRI87.PARANUMEIMPE~~) ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_FINANZIAMENT.SetQuery(PPQRY_FINANZIAME23, 5, SQL, -1, "");
    PAN_FINANZIAMENT.SetQueryDB(PPQRY_FINANZIAME23, MainFrm.Cf4armDBObject.DB, 4);
