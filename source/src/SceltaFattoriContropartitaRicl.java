// **********************************************
// Scelta Fattori Contropartita Ricl
// Project : Cfa
// **********************************************
...
public final class SceltaFattoriContropartitaRicl extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_FATTORI8 = 0;
  ...
  {
    Init_TBL_PARAMETRI502(IMDB);
    //
    //
    Init_PQRY_FATTORI8(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARAMETRI502(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARAMETRI502, 5);
    IMDB.set_TblCode(IMDBDef1.TBL_PARAMETRI502, "TBL_PARAMETRI502");
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMDATREG, "ROWNAMDATREG");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMDATREG,6,49,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMETIPO, "ROWNAMETIPO");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMETIPO,5,1,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMCODLI4, "ROWNAMCODLI4");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMCODLI4,1,52,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMCODLI5, "ROWNAMCODLI5");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMCODLI5,1,52,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMEES, "ROWNAMEES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARAMETRI502,IMDBDef1.FLD_PARAMETRI502_ROWNAMEES,5,1,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARAMETRI502, 0);
  }

  private static void Init_PQRY_FATTORI8(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef8.PQRY_FATTORI8, 4);
    IMDB.set_TblCode(IMDBDef8.PQRY_FATTORI8, "PQRY_FATTORI8");
    IMDB.set_FldCode(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_FATTORE, "FATTORE");
    IMDB.SetFldParams(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_FATTORE,5,16,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_DESCRIZIONE, "DESCRIZIONE");
    IMDB.SetFldParams(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_DESCRIZIONE,5,200,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_FATTORORDINA, "FATTORORDINA");
    IMDB.SetFldParams(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_FATTORORDINA,1,19,0);
    IMDB.set_FldCode(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_TIPO, "TIPO");
    IMDB.SetFldParams(IMDBDef8.PQRY_FATTORI8,IMDBDef8.PQSL_FATTORI8_TIPO,5,1,0);
    IMDB.TblAddNew(IMDBDef8.PQRY_FATTORI8, 0);
  }
  ...
  // **********************************************
  public SceltaFattoriContropartitaRicl(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public SceltaFattoriContropartitaRicl()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCEFATCONRIC;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "64E25363-FCCF-4BCB-87D0-F79C5F4EFCB3";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 748;
    DesignHeight = 358;
    set_Caption(new IDVariant("Scelta Fattori Contropartita Ricl"));
    //
    Frames = new AFrame[2];
    ...
    PAN_FATTORI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "0D963ABD-214B-42BC-8891-B25EF38DF452");
  ...
  {
    return (obj instanceof SceltaFattoriContropartitaRicl);
  }
  ...
  {
    return (FullName ? SceltaFattoriContropartitaRicl.class.getName() : (Glb.ClassWithPackage(SceltaFattoriContropartitaRicl.class) ? SceltaFattoriContropartitaRicl.class.getName().substring(SceltaFattoriContropartitaRicl.class.getPackage().getName().length() + 1) : SceltaFattoriContropartitaRicl.class.getName()));
  }
  ...
  private void PAN_FATTORI_DynamicProperties ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaFattoriContropartitaRicl", "FattoriOnDynamicPropertiesEvent", _e);
    }
  }
  ...
  private void IntFormLoad ()
  {
    ...
    {
      MainFrm.ErrObj.ProcError ("SceltaFattoriContropartitaRicl", "LoadEvent", _e);
    }
  }
  ...
  private void PAN_FATTORI_Init()
  {
    ...
    PAN_FATTORI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FATTORI_FATTORE, "0849811C-03A3-4978-9DF0-ACE2646A218C");
    ...
    PAN_FATTORI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FATTORI_DESCRIZIONE, "DD33F806-EC6F-43B7-A930-681EED9865F5");
    ...
    PAN_FATTORI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FATTORI_TIPO, "190BAC0B-1163-4808-8553-C1FBC7FEE3EA");
    ...
    PAN_FATTORI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_FATTORI_ORDINAMENTO, "2303D217-088E-4BCB-8D06-720F4DC37C33");
  ...
  private void PAN_FATTORI_InitFields()
  {
    ...
    PAN_FATTORI.SetFieldPanel(PFL_FATTORI_FATTORE, PPQRY_FATTORI8, "A.FATTORE", "FATTORE", 5, 16, 0, -13997);
    ...
    PAN_FATTORI.SetFieldPanel(PFL_FATTORI_DESCRIZIONE, PPQRY_FATTORI8, "A.DESCRIZIONE", "DESCRIZIONE", 5, 200, 0, -13997);
    ...
    PAN_FATTORI.SetFieldPanel(PFL_FATTORI_TIPO, PPQRY_FATTORI8, "A.TIPO", "TIPO", 5, 1, 0, -13997);
    ...
    PAN_FATTORI.SetFieldPanel(PFL_FATTORI_ORDINAMENTO, PPQRY_FATTORI8, "DECODE(A.TIPO, 'E', 1, DECODE(A.TIPO, 'A', 2, 3))", "FATTORORDINA", 1, 19, 0, -13997);
  }
  ...
  private void PAN_FATTORI_InitQueries()
  {
    ...
    PAN_FATTORI.SetIMDB(IMDB, "PQRY_FATTORI8", true);
    ...
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  FATTORI A, ");
    SQL.append("  VISTA_STRUTTURA_RICL B ");
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (B.CONTROPARTITA = A.FATTORE) ");
    SQL.append("and   ((A.DATA_VALIDITA IS NULL) OR A.DATA_VALIDITA >= NVL(~~TBL_PARAMETRI502.ROWNAMDATREG~~, TO_DATE('1900-01-01','YYYY-MM-DD'))) ");
    SQL.append("and   ((~~TBL_DATISESSIONE.SESSIOESERCI~~ BETWEEN B.ESERCIZIO_INIZIO AND B.ESERCIZIO_SCADENZA)) ");
    SQL.append("and   (B.E_S = ~~TBL_PARAMETRI502.ROWNAMEES~~) ");
    SQL.append("and   ((((B.CODICE = ~~TBL_PARAMETRI502.ROWNAMCODLI4~~) AND (B.CODICE_TIPO_RICL = 'MACRO')) OR ((B.CODICE_PADRE = ~~TBL_PARAMETRI502.ROWNAMCODLI4~~) AND (B.CODICE_TIPO_RICL = 'MACRO_5'))) AND ((NOT ((~~TBL_PARAMETRI502.ROWNAMCODLI5~~ IS NULL)) AND ((B.CODICE = ~~TBL_PARAMETRI502.ROWNAMCODLI5~~) AND (B.CODICE_TIPO_RICL = 'MACRO_5'))) OR (~~TBL_PARAMETRI502.ROWNAMCODLI5~~ IS NULL))) ");
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by 3, 1 ");
    PAN_FATTORI.SetQuery(PPQRY_FATTORI8, 5, SQL, -1, "");
    PAN_FATTORI.SetQueryDB(PPQRY_FATTORI8, MainFrm.Cf4armDBObject.DB, 4);
