// **********************************************
// Capitoli Con Disponibilita Negativa Imputazioni
// Project : Cfa
// **********************************************
...
public final class CapitoliConDisponibilitaNegativaImputazioni extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_MOVIMCASSGC8 = 0;
  ...
  {
    Init_TBL_PARS50(IMDB);
    //
    //
    Init_PQRY_MOVIMCASSGC8(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS50(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef5.TBL_PARS50, 4);
    IMDB.set_TblCode(IMDBDef5.TBL_PARS50, "TBL_PARS50");
    IMDB.set_FldCode(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGCADINE, "NOMOGGCADINE");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGCADINE,1,12,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMEOGGEVPRO, "NOMEOGGEVPRO");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMEOGGEVPRO,5,2,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGNUMDIS, "NOMOGGNUMDIS");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGNUMDIS,1,6,0);
    IMDB.set_FldCode(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGANNDIS, "NOMOGGANNDIS");
    IMDB.SetFldParams(IMDBDef5.TBL_PARS50,IMDBDef5.FLD_PARS50_NOMOGGANNDIS,1,4,0);
    IMDB.TblAddNew(IMDBDef5.TBL_PARS50, 0);
  }

  private static void Init_PQRY_MOVIMCASSGC8(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef14.PQRY_MOVIMCASSGC8, 5);
    IMDB.set_TblCode(IMDBDef14.PQRY_MOVIMCASSGC8, "PQRY_MOVIMCASSGC8");
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_RECORBILCAPI, "RECORBILCAPI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_RECORBILCAPI,3,16,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_RECORBILARTI, "RECORBILARTI");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_RECORBILARTI,1,2,0);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_TOTALEIMPORT, "TOTALEIMPORT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_TOTALEIMPORT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_DISPONIBILIT, "DISPONIBILIT");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_DISPONIBILIT,3,28,6);
    IMDB.set_FldCode(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_VARPROVVISOR, "VARPROVVISOR");
    IMDB.SetFldParams(IMDBDef14.PQRY_MOVIMCASSGC8,IMDBDef14.PQSL_MOVIMCASSGC8_VARPROVVISOR,3,28,6);
    IMDB.TblAddNew(IMDBDef14.PQRY_MOVIMCASSGC8, 0);
  }
  ...
  // **********************************************
  public CapitoliConDisponibilitaNegativaImputazioni(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  // Costruttore per form multiple
  // **********************************************
  public CapitoliConDisponibilitaNegativaImputazioni()
  {
    super();
    //
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_CAPCONDINEIM;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "66F9D7F3-4F91-45A1-8CB0-27EBFBAA156D";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 792;
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "0A29D0ED-D256-4C49-881F-16FFFC205426");
  ...
  {
    return (obj instanceof CapitoliConDisponibilitaNegativaImputazioni);
  }
  ...
  {
    return (FullName ? CapitoliConDisponibilitaNegativaImputazioni.class.getName() : (Glb.ClassWithPackage(CapitoliConDisponibilitaNegativaImputazioni.class) ? CapitoliConDisponibilitaNegativaImputazioni.class.getName().substring(CapitoliConDisponibilitaNegativaImputazioni.class.getPackage().getName().length() + 1) : CapitoliConDisponibilitaNegativaImputazioni.class.getName()));
  }
  ...
  public void IntFormUnload (IDVariant Cancel, IDVariant Confirm)
  {
    ...
    try
    {
      ...
      // IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMOGGCADINE, 0, new IDVariant(I));
      // IDVariant v_COMMIT = new IDVariant(0,IDVariant.INTEGER);
      // if (IMDB.Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMOGGCADINE, 0).equals((new IDVariant(0)), true))
      // {
    ...
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaImputazioni", "Unload", _e);
    }
  }
  ...
  {
    IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMOGGCADINE, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMEOGGEVPRO, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMOGGNUMDIS, 0, new IDVariant());
    IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMOGGANNDIS, 0, new IDVariant());
  }
  ...
  private void IntFormLoad ()
  {
    ...
    try
    {
      ...
      QV.Close();
      IMDB.set_Value(IMDBDef5.TBL_PARS50, IMDBDef5.FLD_PARS50_NOMEOGGEVPRO, 0, ((!(IDL.IsNull(v_VT99COCAVPLI)))?(new IDVariant("SI")):(new IDVariant("NO"))));
    }
    catch (Exception _e)
    {
      MainFrm.ErrObj.ProcError ("CapitoliConDisponibilitaNegativaImputazioni", "Load", _e);
    }
  }
  ...
  private void PAN_CAPITOLI_Init()
  {
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_CAPITOLO, "5681AEA2-37F9-4EEB-99CC-0C068E0A793C");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_ARTICOLO, "06B92D6D-DD39-4BF7-887D-00CD0E863CE3");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_TOTALEIMPORT, "2694CE0B-9E5D-474E-845C-177A3F9AF3CD");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DISPONIBILIT, "AE11D6E7-E4D8-4F4F-8EB0-9938BD2676B7");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_VARPROVVISOR, "4E40307E-8EED-46CB-839B-0BA03E87FF5C");
    ...
    PAN_CAPITOLI.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_CAPITOLI_DUALDISPRISU, "7ABE0ADF-EECE-4B7A-BBA9-59C730511A42");
  ...
  private void PAN_CAPITOLI_InitFields()
  {
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_CAPITOLO, PPQRY_MOVIMCASSGC8, "D.CAPITOLO", "RECORBILCAPI", 3, 16, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_ARTICOLO, PPQRY_MOVIMCASSGC8, "D.ARTICOLO", "RECORBILARTI", 1, 2, 0, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_TOTALEIMPORT, PPQRY_MOVIMCASSGC8, "SUM(B.IMPORTO)", "TOTALEIMPORT", 3, 28, 6, -13997);
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_DISPONIBILIT, PPQRY_MOVIMCASSGC8, "MAX(D.DISPONIBILITA_CA)", "DISPONIBILIT", 3, 28, 6, -13997);
  ...
  SQL.append("))");
    ...
    PAN_CAPITOLI.SetFieldPanel(PFL_CAPITOLI_VARPROVVISOR, PPQRY_MOVIMCASSGC8, SQL.toString(), "VARPROVVISOR", 3, 28, 6, -13997);
  ...
  private void PAN_CAPITOLI_InitQueries()
  {
    ...
    PAN_CAPITOLI.SetIMDB(IMDB, "PQRY_MOVIMCASSGC8", true);
    ...
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  IMPUTAZIONI B, ");
    SQL.append("  LIQ C, ");
    SQL.append("  BIL D ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (B.ANNO_DISTINTA = ~~TBL_PARS50.NOMOGGANNDIS~~) ");
    SQL.append("and   (B.NUMERO_DISTINTA = ~~TBL_PARS50.NOMOGGNUMDIS~~) ");
    ...
    SQL.append("and   (CONTROLLO_DISP_CASSA_VPRO_CAP(D.ESERCIZIO,D.CAPITOLO,D.ARTICOLO,CASE WHEN ~~TBL_PARS50.NOMEOGGEVPRO~~ = 'SI' THEN 'LI' ELSE 'EM' END) < 0) ");
    SQL.append("and   (~~TBL_PARS50.NOMEOGGEVPRO~~ = 'SI' OR (~~TBL_PARS50.NOMEOGGEVPRO~~ = 'NO' AND NOT ((C.ANNO_MAND IS NULL)))) ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 2, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("group by ");
    SQL.append("  D.CAPITOLO, ");
    SQL.append("  D.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  D.CAPITOLO, ");
    SQL.append("  D.ARTICOLO ");
    PAN_CAPITOLI.SetQuery(PPQRY_MOVIMCASSGC8, 5, SQL, -1, "");
    PAN_CAPITOLI.SetQueryDB(PPQRY_MOVIMCASSGC8, MainFrm.Cf4armDBObject.DB, 4);
    PAN_CAPITOLI.SetMasterTable(0, "IMPUTAZIONI");
