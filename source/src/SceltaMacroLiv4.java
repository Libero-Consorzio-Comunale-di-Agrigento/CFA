...
public final class SceltaMacroLiv4 extends MyWebForm implements Serializable
{  
  ...
  private static int PPQRY_VISTSTRURIC4 = 0;
  ...
  {
    Init_TBL_PARS36(IMDB);
    //
    //
    Init_PQRY_VISTSTRURIC4(IMDB);
  }

  // IMDB DDL Procedures
  private static void Init_TBL_PARS36(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef1.TBL_PARS36, 4);
    IMDB.set_TblCode(IMDBDef1.TBL_PARS36, "TBL_PARS36");
    IMDB.set_FldCode(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMEOGGETTES, "NOMEOGGETTES");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMEOGGETTES,5,1,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMEOGGEESER, "NOMEOGGEESER");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMEOGGEESER,1,4,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMOGGMISTIT, "NOMOGGMISTIT");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMOGGMISTIT,1,2,0);
    IMDB.set_FldCode(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMOGGPROTIP, "NOMOGGPROTIP");
    IMDB.SetFldParams(IMDBDef1.TBL_PARS36,IMDBDef1.FLD_PARS36_NOMOGGPROTIP,1,4,0);
    IMDB.TblAddNew(IMDBDef1.TBL_PARS36, 0);
  }

  private static void Init_PQRY_VISTSTRURIC4(IMDBObj IMDB)
  {
    IMDB.set_TblNumField(IMDBDef7.PQRY_VISTSTRURIC4, 2);
    IMDB.set_TblCode(IMDBDef7.PQRY_VISTSTRURIC4, "PQRY_VISTSTRURIC4");
    IMDB.set_FldCode(IMDBDef7.PQRY_VISTSTRURIC4,IMDBDef7.PQSL_VISTSTRURIC4_VISSTRRICCOD, "VISSTRRICCOD");
    IMDB.SetFldParams(IMDBDef7.PQRY_VISTSTRURIC4,IMDBDef7.PQSL_VISTSTRURIC4_VISSTRRICCOD,1,10,0);
    IMDB.set_FldCode(IMDBDef7.PQRY_VISTSTRURIC4,IMDBDef7.PQSL_VISTSTRURIC4_VISSTRRICDES, "VISSTRRICDES");
    IMDB.SetFldParams(IMDBDef7.PQRY_VISTSTRURIC4,IMDBDef7.PQSL_VISTSTRURIC4_VISSTRRICDES,5,300,0);
    IMDB.TblAddNew(IMDBDef7.PQRY_VISTSTRURIC4, 0);
  }
  ...
  // **********************************************
  public SceltaMacroLiv4(MyWebEntryPoint w, IMDBObj imdb)
  {
    //
    SetMainFrm(w,imdb);
  }
  ...
  public void Init(WebEntryPoint w, boolean flMulti, boolean flSubForm)
  {
    ...
    //
    FormIdx = MyGlb.FRM_SCELMACRLIV4;
    //
    if (flMulti)
    ...
    //
    RTCGuid = "5ED43619-9BF2-4D60-B802-D62A496F13EB";
    ResModeW = 1;
    ResModeH = 1;
    iVisualFlags = -2049;
    DesignWidth = 640;
    DesignHeight = 370;
    set_Caption(new IDVariant("Scelta Macro Liv 4"));
    //
    Frames = new AFrame[2];
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_PANEL, 0, "7CDB81E4-47AD-416A-939E-093AAEAE950A");
  ...
  {
    return (obj instanceof SceltaMacroLiv4);
  }
  ...
  {
    return (FullName ? SceltaMacroLiv4.class.getName() : (Glb.ClassWithPackage(SceltaMacroLiv4.class) ? SceltaMacroLiv4.class.getName().substring(SceltaMacroLiv4.class.getPackage().getName().length() + 1) : SceltaMacroLiv4.class.getName()));
  }
  ...
  private void PAN_VISTSTRURICL_Init()
  {
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_CODICE, "ED12DA9E-F73C-4D41-A8A5-2B400C5A161F");
    ...
    PAN_VISTSTRURICL.SetRTCGuid(MyGlb.OBJ_FIELD, PFL_VISTSTRURICL_DESCRIZIONE, "16533131-107F-4BC8-BABB-B6BD4A40125E");
  ...
  private void PAN_VISTSTRURICL_InitFields()
  {
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_CODICE, PPQRY_VISTSTRURIC4, "A.CODICE", "VISSTRRICCOD", 1, 10, 0, -13997);
    ...
    PAN_VISTSTRURICL.SetFieldPanel(PFL_VISTSTRURICL_DESCRIZIONE, PPQRY_VISTSTRURIC4, "A.DESCRIZIONE", "VISSTRRICDES", 5, 300, 0, -13997);
  }
  ...
  private void PAN_VISTSTRURICL_InitQueries()
  {
    ...
    PAN_VISTSTRURICL.SetIMDB(IMDB, "PQRY_VISTSTRURIC4", true);
    ...
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 0, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("from ");
    SQL.append("  VISTA_STRUTTURA_RICL A ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 1, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("where (A.CODICE_TIPO_RICL = 'MACRO') ");
    SQL.append("and   (A.E_S = ~~TBL_PARS36.NOMEOGGETTES~~) ");
    SQL.append("and   (A.LIVELLO = 4) ");
    SQL.append("and   (NVL(A.ESERCIZIO_INIZIO, 0) <= ~~TBL_PARS36.NOMEOGGEESER~~) ");
    SQL.append("and   (A.ESERCIZIO_SCADENZA >= ~~TBL_PARS36.NOMEOGGEESER~~) ");
    SQL.append("and   (CONTROLLA_COD_STRUTT_MACRO4(~~TBL_PARS36.NOMEOGGEESER~~,~~TBL_PARS36.NOMEOGGETTES~~,A.CODICE,~~TBL_PARS36.NOMOGGMISTIT~~,~~TBL_PARS36.NOMOGGPROTIP~~) = 'SI') ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 2, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 3, SQL, -1, "");
    SQL = new StringBuffer();
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 4, SQL, -1, "");
    SQL = new StringBuffer();
    SQL.append("order by ");
    SQL.append("  A.CODICE ");
    PAN_VISTSTRURICL.SetQuery(PPQRY_VISTSTRURIC4, 5, SQL, -1, "");
    PAN_VISTSTRURICL.SetQueryDB(PPQRY_VISTSTRURIC4, MainFrm.Cf4armDBObject.DB, 4);
